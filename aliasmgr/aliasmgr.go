...
// lookup flag indicates whether we want to only store a mapping from the alias
// to its base scid. The linkUpdate flag is used to signal whether this function
// should also trigger an update on the htlcswitch scid alias maps.
