...
var errEmptyMerkleInput = errors.New("cannot compute Merkle root over empty " +
	"TLV set")
...
// as byte concatenation, not UTF-8 joining.
...
// merkleRoot does not check the ordering, so unsorted or duplicate input
// produces an incorrect root silently.
//
