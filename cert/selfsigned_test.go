...
func TestIsOutdatedCert(t *testing.T) {
	...
	_, _, err = cert.GenCertPair(
		...
		extraDomains[:2], cert.DefaultAutogenValidity, false, false, keyRing,
	)
	if err != nil {
		t.Fatal(err)
	}
...
func TestIsOutdatedPermutation(t *testing.T) {
	...
	_, _, err = cert.GenCertPair(
		...
		extraDomains[:], cert.DefaultAutogenValidity, false, false, keyRing,
	)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTLSDisableAutofill(t *testing.T) {
	...
	err = cert.GenCertPair(
		"lnd autogenerated cert", certPath, keyPath, extraIPs[:2],
		extraDomains[:2], cert.DefaultAutogenValidity, true, false, keyRing,
	)
	require.NoError(
		t, err,
