...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/lightningnetwork/lnd/chainnotif)

The chainnotif package implements a set of interfaces which allow callers to
...
```shell
$  go get -u github.com/lightningnetwork/lnd/chainnotif
```
