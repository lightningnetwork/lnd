...
// time.
var _ chainnotif.ChainNotifier = (*BitcoindNotifier)(nil)

// Ensure BitcoindNotifier implements the MempoolWatcher interface at compile
// time.
var _ chainnotif.MempoolWatcher = (*BitcoindNotifier)(nil)
...
func (b *BitcoindNotifier) Stop() error {
	...
	chainnotif.Log.Info("bitcoind notifier shutting down...")
	defer chainnotif.Log.Debug("bitcoind notifier shutdown complete")
		...
		case registerMsg := <-b.notificationRegistry:
			...
			case *chainnotif.HistoricalConfDispatch:
				...
				go func(msg *chainnotif.HistoricalConfDispatch) {
					...
					if err != nil {
						chainnotif.Log.Errorf("Rescan to "+
							"determine the conf "+
							"details of %v within "+
							"range %d-%d failed: %v",
							msg.ConfRequest,
			...
			case *chainnotif.HistoricalSpendDispatch:
				...
				//nolint:lll
				go func(msg *chainnotif.HistoricalSpendDispatch) {
					defer b.wg.Done()
					...
					chainnotif.Log.Infof("Historical "+
...
func (b *BitcoindNotifier) handleBlockConnected(block chainnotif.BlockEpoch) error {
	...
	chainnotif.Log.Infof("New block: height=%v, sha=%v", block.Height,
		block.Hash)
...
func (b *BitcoindNotifier) RegisterSpendNtfn(outpoint *wire.OutPoint,
	...
	// make for scripts.
	if ntfn.HistoricalDispatch.OutPoint == chainnotif.ZeroOutPoint {
		select {
...
func (b *BitcoindNotifier) historicalSpendDetails(
	spendRequest chainnotif.SpendRequest, startHeight, endHeight uint32) (
