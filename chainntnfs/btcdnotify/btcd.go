...
// pkScript scan for the btcd backend.
func (b *BtcdNotifier) queueHistoricalPkScriptDispatch(
...
// scan slot.
func (b *BtcdNotifier) reserveHistoricalPkScriptDispatchSlot() error {
	select {
	case <-b.quit:
...
// scan slot.
func (b *BtcdNotifier) releaseHistoricalPkScriptDispatchSlot() {
	select {
...
func (b *BtcdNotifier) queueReservedHistoricalPkScriptDispatch(
	msg *chainntnfs.HistoricalPkScriptDispatch) error {
...
// scans.
func (b *BtcdNotifier) historicalPkScriptDispatcher() {
	defer b.wg.Done()
...
// single subscription.
func (b *BtcdNotifier) historicalPkScriptDispatch(
	msg *chainntnfs.HistoricalPkScriptDispatch) error {
