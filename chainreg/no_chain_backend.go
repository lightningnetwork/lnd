...
func (n *NoChainSource) Rescan(*chainhash.Hash, []btcaddr.Address,
	map[wire.OutPoint]btcaddr.Address) error {

	return nil
}

func (n *NoChainSource) NotifyReceived([]btcaddr.Address) error {
	return nil
}
