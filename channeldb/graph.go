...
type ChannelEdgePolicy struct {
	...
	// ChannelFlags is a bitfield which signals the capabilities of the channel
	// as well as the directed edge this update applies to.
	ChannelFlags lnwire.ChanUpdateFlag

	// MessageFlags is a bitfield which indicates the presence of the MaxHTLC
	// field in the policy.
	MessageFlags lnwire.ChanUpdateFlag
