...
type Invoice struct {
	// PaymentHash is the hash that identifies this invoice and htlcs paying
	// to it.
...
func (d *DB) AddInvoice(newInvoice *Invoice) (
	...
	err := d.Update(func(tx *bbolt.Tx) error {
		...
		if invoiceIndex.Get(newInvoice.PaymentHash[:]) != nil {
		...
		newIndex, err := putInvoice(invoices, invoiceIndex, addIndex,
...
// error.
func (d *DB) AcceptInvoice(paymentHash lntypes.Hash,
	amtPaid lnwire.MilliSatoshi) (*Invoice, error) {
...
func putInvoice(invoices, invoiceIndex, addIndex *bbolt.Bucket,
	...
	err := invoiceIndex.Put(i.PaymentHash[:], invoiceKey[:])
	if err != nil {
		return 0, err
	}
...
func serializeInvoice(w io.Writer, i *Invoice) error {
	...
	if _, err := w.Write(i.PaymentHash[:]); err != nil {
...
func deserializeInvoice(r io.Reader) (Invoice, error) {
	...
	if _, err := io.ReadFull(r, invoice.PaymentHash[:]); err != nil {
		return invoice, err
	}
	var scratch [8]byte
...
func settleInvoice(invoices, settleIndex *bbolt.Bucket, invoiceNum []byte,
	...
	// If invoice is accepted, AmtPaid has been set already.
