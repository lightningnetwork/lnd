...
func cancelHtlcsAmp(invoice *invpkg.Invoice,
	updateMap map[invpkg.SetID]map[models.CircuitKey]*invpkg.InvoiceHTLC,
	htlc *invpkg.InvoiceHTLC, circuitKey models.CircuitKey) error {
...
// cancelHTLCsStoreUpdate is a helper function used to store the invoice and
// AMP state after canceling HTLCs.
...
// addHTLCsStoreUpdate is a helper function used to store the invoice and
// AMP state after adding HTLCs.
...
// settleHodlInvoiceStoreUpdate is a helper function used to store the settled
// hodl invoice update.
...
// cancelInvoiceStoreUpdate is a helper function used to store the canceled
// invoice update.
