...
func serializeHTLCSettleInfo(w io.Writer, s *payments.HTLCSettleInfo) error {
...
func deserializeHTLCSettleInfo(r io.Reader) (*payments.HTLCSettleInfo, error) {
	s := &payments.HTLCSettleInfo{}
...
// wire failure.
func serializeHTLCFailInfo(w io.Writer, f *payments.HTLCFailInfo) error {
...
// the wire failure.
func deserializeHTLCFailInfo(r io.Reader) (*payments.HTLCFailInfo, error) {
	f := &payments.HTLCFailInfo{}
	var err error
	...
	f.Reason = payments.HTLCFailReason(reason)
