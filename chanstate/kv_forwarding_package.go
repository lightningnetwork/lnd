...
//
// NOTE: This accessor is only needed because TestRefresh still lives in the
// channeldb package and can no longer reach the unexported source field
// directly. It can be removed once all channel state tests have been moved
// into the chanstate package.
