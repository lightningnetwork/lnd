...
var bumpFeeCommand = cli.Command{
	...
	Flags: []cli.Flag{
		...
		cli.Uint64Flag{
			Name: "budget",
			Usage: "the max amount in sats that can be used as " +
				"fees for the sweep, setting this value " +
				"greater than the input's value will result " +
				"in wallet UTXOs being used for CPFP",
		},
		cli.Uint64Flag{
			Name:   "sat_per_byte",
