...
var bumpFeeCommand = cli.Command{
	...
	whether it's a new input or not, this can be either an CPFP or RBF.
	...
	When bumping the fee of an existing input, a higher fee transaction
	will be created that replaces the lower fee transaction through the
