	...
	Flags: []cli.Flag{
		cli.Uint64Flag{
			...
			Usage: "(optional) the number of blocks that the " +
				"output should be swept on-chain within",
		},
		cli.Uint64Flag{
			Name:   "sat_per_byte",
		...
		cli.Uint64Flag{
			...
			Usage: "(optional) a manual fee expressed in " +
				"sat/vbyte that should be used when sweeping " +
				"the output",
		},
		cli.BoolFlag{
			Name:  "immediate",
			Usage: "sweep immediately",
		},
		cli.Uint64Flag{
			Name: "budget",
			Usage: "(optional) the max amount in sats that can " +
				"be used as fees for the sweep, setting this " +
				"value greater than the input's value will " +
				"result in wallet UTXOs being used for CPFP",
		},
	},
