...
type Config struct {
	...
	ChanRequiredBandwidth         btcutil.Amount `long:"chan-required-bandwidth" description:"The minimum required bandwidth above the channel reserve to not disable the channel automatically."`
