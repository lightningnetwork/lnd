...
type Config struct {
	...
	NoForwardingHistory bool `long:"no-forwarding-history" description:"If set, payment forwarding events will not be persisted to the database. LND will operate normally otherwise."`
