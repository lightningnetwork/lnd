...
func (d *DefaultDatabaseBuilder) BuildDatabase(
	...
	if d.cfg.DB.UseNativeSQL {
		...
		// If we found invoices in the KV store and the user didn't
		// explicitly wanted to avoid the migration, we'll attempt to
		// migrate the invoices to the native SQL store.
