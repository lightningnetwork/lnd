...
func (c *chainWatcher) handleUnknownLocalState(
	commitSpend *chainnotif.SpendDetail, broadcastStateNum uint64,
...
func (c *chainWatcher) closeObserver(spendNtfn *chainnotif.SpendEvent) {
	defer c.wg.Done()
...
func (c *chainWatcher) handlePossibleBreach(commitSpend *chainnotif.SpendDetail,
