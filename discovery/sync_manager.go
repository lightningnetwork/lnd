...
func (m *SyncManager) deriveRateLimitReservation(ctx context.Context,
	peerPub [33]byte, msg lnwire.Message) (*rate.Reservation, error) {
...
func (m *SyncManager) maybeRateLimitMsg(ctx context.Context, peerPub [33]byte,
	...
	delay, err := m.deriveRateLimitReservation(ctx, peerPub, msg)
	if err != nil {
		return nil
	}
