...
// hodlHtlc is used in the hodlMap field to keep track of the htlcs associated
// with a hash.
...
// processHodlEvent processes a received hodl event and updates the commit tx if
// necessary.
...
// processSingleHodlEvent processes a received hodl event. It returns a boolean
// indicating whether the commit tx needs to be updated.
...
func (l *channelLink) processExitHop(pd *lnwallet.PaymentDescriptor,
	...
	// after this, this code will be re-executed after restart. When the
	// invoice registry decides what to do with this htlc, it will send the
	// resolution on the hodlQueue that we pass into this call.
