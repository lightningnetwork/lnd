...
func TestChannelLinkInboundFee(t *testing.T) {
	...
	t.Run("negative", func(t *testing.T) {
		...
		// inbound fee is -0.01% of the sum, which is -101 (rounded up).
		// Added to this is the base inbound fee of -500, making for a
		// total inbound fee of -601.
		const expectedBobInFee = -601
