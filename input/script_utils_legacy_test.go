...
func legacySenderHTLCScript(senderHtlcKey, receiverHtlcKey,
	...
	builder.AddData(btcaddr.Hash160(revocationKey.SerializeCompressed()))
...
// transaction.
func legacyCommitScriptToSelf(csvTimeout uint32, selfKey,
...
func legacyCommitScriptUnencumbered(key *btcec.PublicKey) ([]byte, error) {
	...
	builder.AddData(btcaddr.Hash160(key.SerializeCompressed()))
