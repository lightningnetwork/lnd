...
// PayToTaprootScript creates a new script to pay to a version 1
// (taproot) witness program. The passed public key will be serialized as an
// x-only key to create the witness program.
