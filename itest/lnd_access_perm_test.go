...
var peerConnTestCases = []*lntest.TestCase{
	...
	{
		Name:     "upgrade perm",
		TestFunc: testPeerConnUpgradePerm,
	},
	{
		Name:     "node restart",
...
func testPeerConnRestrictedOnInbound(ht *lntest.HarnessTest) {
	...
	ht.ConnectNodesNoAssert(bob, alice)
	...
	ht.ConnectNodesNoAssert(carol, alice)
