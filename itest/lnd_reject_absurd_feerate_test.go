...
func testRejectAbsurdCommitFeerate(ht *lntest.HarnessTest) {
	...
	require.LessOrEqual(ht, int64(initiatorBalance),
		int64(initiatorReserve),
		"the initiator's balance must be at or below "+
			"the reserve it named")
	...
	ht.OpenChannelAssertErr(
		alice, bob, params, lnwallet.ErrBalancesBelowReserveBase,
	)
