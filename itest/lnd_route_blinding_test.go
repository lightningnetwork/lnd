...
func testPartiallySpecifiedBlindedPath(ht *lntest.HarnessTest) {
	...
	// Assert that it contains two paths are selected: one 3 hop one
	// starting at Eve and a 3 hop one starting at Dave (this one will be
	// padded with a dummy hop) in order to keep all the paths equidistant.
