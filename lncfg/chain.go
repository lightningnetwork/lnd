...
type Chain struct {
	...
	AssetMinHTLCIn      omnicore.Amount `long:"assetminhtlc" description:"The smallest HTLC we are willing to accept on our asset-channels, in omnicore.Amount, 1 AssetUnit= 100000000 omnicore.Amount"`
