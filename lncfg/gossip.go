...
type Gossip struct {
	...
	SyncerV2 bool `long:"syncer-v2" description:"Use the experimental actor based gossip syncer. It speaks the same gossip query protocol and honors the same gossip settings, and replaces only how lnd schedules and runs graph sync internally."`
}
