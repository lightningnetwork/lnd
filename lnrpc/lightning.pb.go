...
var file_lightning_proto_depIdxs = []int32{
	...
	222, // 8: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	...
	223, // 13: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	1,   // 14: lnrpc.EstimateFeeRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	224, // 15: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	245, // 129: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	210, // 137: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	...
	246, // 141: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	153, // 142: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	181, // 143: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	40,  // 144: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	183, // 145: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	41,  // 146: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	11,  // 147: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	185, // 148: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	188, // 149: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	40,  // 150: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	40,  // 151: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	40,  // 152: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	195, // 153: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	192, // 154: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	191, // 155: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	195, // 156: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	200, // 157: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	200, // 158: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	247, // 159: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 160: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	211, // 161: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	213, // 162: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	200, // 163: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	217, // 164: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	218, // 165: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	218, // 166: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	220, // 167: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	221, // 168: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	179, // 169: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 170: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	228, // 173: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	228, // 174: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	231, // 175: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	228, // 176: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	228, // 177: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	110, // 178: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	115, // 180: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	179, // 181: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	139, // 182: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	179, // 183: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 184: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	156, // 185: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	179, // 186: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	207, // 187: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	116, // 188: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	119, // 189: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	32,  // 190: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	44,  // 191: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	48,  // 192: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	50,  // 193: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	32,  // 194: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	46,  // 195: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	52,  // 196: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	54,  // 197: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	56,  // 198: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	58,  // 199: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	60,  // 200: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	76,  // 201: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	78,  // 202: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	80,  // 203: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	82,  // 204: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	84,  // 205: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	111, // 206: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	65,  // 207: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	113, // 208: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	72,  // 209: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	98,  // 210: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	98,  // 211: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	95,  // 212: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	108, // 213: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	39,  // 214: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	90,  // 215: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	173, // 216: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	35,  // 217: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	35,  // 218: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	37,  // 219: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	37,  // 220: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	157, // 221: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	162, // 222: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	161, // 223: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	164, // 224: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	177, // 225: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	167, // 226: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	169, // 227: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	170, // 228: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	135, // 229: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	137, // 230: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	140, // 231: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	129, // 232: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	121, // 233: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	141, // 234: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	143, // 235: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	145, // 236: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	175, // 237: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	180, // 238: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	184, // 239: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	187, // 240: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	190, // 241: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	193, // 242: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	194, // 243: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	196, // 244: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	198, // 245: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	201, // 246: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	203, // 247: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	205, // 248: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	208, // 249: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	214, // 250: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	219, // 251: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	27,  // 252: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	25,  // 253: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	68,  // 254: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	23,  // 255: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	21,  // 256: lnrpc.Lightning.Quiesce:input_type -> lnrpc.QuiescenceRequest
	117, // 257: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	120, // 258: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	33,  // 259: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	45,  // 260: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	49,  // 261: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	51,  // 262: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	31,  // 263: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	47,  // 264: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	53,  // 265: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	55,  // 266: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	57,  // 267: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	59,  // 268: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	61,  // 269: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	77,  // 270: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	79,  // 271: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	81,  // 272: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	83,  // 273: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	85,  // 274: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	112, // 275: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	66,  // 276: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	114, // 277: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	73,  // 278: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	40,  // 279: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	99,  // 280: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	97,  // 281: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	109, // 282: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	38,  // 283: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	91,  // 284: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	174, // 285: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	36,  // 286: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	36,  // 287: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	36,  // 288: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	36,  // 289: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	160, // 290: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	163, // 291: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	157, // 292: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	157, // 293: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	178, // 294: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	168, // 295: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	171, // 296: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	172, // 297: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	136, // 298: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	138, // 299: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	134, // 300: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	130, // 301: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	124, // 302: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	142, // 303: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	144, // 304: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	146, // 305: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	176, // 306: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	182, // 307: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	186, // 308: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	189, // 309: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	191, // 310: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	194, // 311: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	199, // 312: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	197, // 313: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	194, // 314: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	202, // 315: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	204, // 316: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	206, // 317: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	209, // 318: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	215, // 319: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	216, // 320: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	28,  // 321: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	26,  // 322: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	69,  // 323: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	24,  // 324: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	22,  // 325: lnrpc.Lightning.Quiesce:output_type -> lnrpc.QuiescenceResponse
