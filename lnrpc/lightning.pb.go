...
type CloseChannelRequest struct {
	...
	// `num_pending_htlcs` if there are in flight HTLCs that still need to be
	...
	// and the rpc will block while it waits for the exsting in flight HTLCs to
	...
	// will continue to wait for the in flight HTLCs to be resolved and then
	...
	// attempted and there are in flight HTLCs on the channel, then the rpc call
	...
	// flight HTLCs on the channel OR a force close is attempted with
	// `no_wait=true` it will still result in an immediate `close_instant`
	// message being returned on the stream but `num_pending_htlcs` will be 0
	// and *nearly* immediately after that the `close_pending` message will be
	// returned on the stream. If a coop close is attempted with no in flight
	// HTLCs on the channel OR a force close is attempted with `no_wait=false`,
	...
	// are in flight HTLCs on the channel and a coop close is attempted. It then
	// indirectly controls if the rpc call later waits for in flight HTLCs to be
	// resolved before attempting a coop close or if it will instantly fail. The
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*ChannelAuthProof)(nil),                                    // 133: lnrpc.ChannelAuthProof
...
var file_lightning_proto_depIdxs = []int32{
	...
	236, // 81: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	237, // 91: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	152, // 92: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	153, // 93: lnrpc.QueryRoutesRequest.blinded_payment_paths:type_name -> lnrpc.BlindedPaymentPath
	...
	238, // 98: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	124, // 99: lnrpc.Route.hops:type_name -> lnrpc.Hop
	130, // 100: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	134, // 101: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	131, // 102: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	239, // 103: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	240, // 104: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	241, // 105: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	...
	242, // 108: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	133, // 109: lnrpc.ChannelEdge.auth_proof:type_name -> lnrpc.ChannelAuthProof
	130, // 110: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	134, // 111: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	7,   // 112: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	243, // 113: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	147, // 114: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	148, // 115: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	149, // 116: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	131, // 117: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	244, // 118: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	150, // 122: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	154, // 123: lnrpc.BlindedPaymentPath.blinded_path:type_name -> lnrpc.BlindedPath
	10,  // 124: lnrpc.BlindedPaymentPath.features:type_name -> lnrpc.FeatureBit
	155, // 125: lnrpc.BlindedPath.blinded_hops:type_name -> lnrpc.BlindedHop
	8,   // 126: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	152, // 127: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	17,  // 128: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	159, // 129: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	245, // 130: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	246, // 131: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	158, // 132: lnrpc.Invoice.blinded_path_config:type_name -> lnrpc.BlindedPathConfig
	8,   // 133: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	247, // 134: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	160, // 135: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	157, // 136: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	18,  // 137: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	167, // 138: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	9,   // 139: lnrpc.Payment.failure_reason:type_name -> lnrpc.PaymentFailureReason
	248, // 140: lnrpc.Payment.first_hop_custom_records:type_name -> lnrpc.Payment.FirstHopCustomRecordsEntry
	...
	211, // 143: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	166, // 144: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	38,  // 145: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	152, // 146: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	249, // 147: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	153, // 148: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	182, // 149: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	38,  // 150: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	184, // 151: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	...
	186, // 154: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	189, // 155: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	...
	196, // 159: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	193, // 160: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	192, // 161: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	196, // 162: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	201, // 163: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	201, // 164: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	250, // 165: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 166: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	212, // 167: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	214, // 168: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	201, // 169: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	219, // 170: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	220, // 171: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	220, // 172: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	251, // 173: lnrpc.RPCMiddlewareRequest.metadata_pairs:type_name -> lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
	222, // 174: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	223, // 175: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	180, // 176: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	180, // 177: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	230, // 180: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	230, // 181: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	233, // 182: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	230, // 183: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	230, // 184: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	180, // 188: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	139, // 189: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	180, // 190: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	180, // 191: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	156, // 192: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	180, // 193: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	208, // 194: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	218, // 195: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry.value:type_name -> lnrpc.MetadataValues
	...
	174, // 224: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	...
	157, // 229: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	163, // 230: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	162, // 231: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	165, // 232: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	178, // 233: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	168, // 234: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	170, // 235: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	171, // 236: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	135, // 237: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	137, // 238: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	140, // 239: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	...
	141, // 242: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	143, // 243: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	145, // 244: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	176, // 245: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	181, // 246: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	185, // 247: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	188, // 248: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	191, // 249: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	194, // 250: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	195, // 251: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	197, // 252: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	199, // 253: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	202, // 254: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	204, // 255: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	206, // 256: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	209, // 257: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	215, // 258: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	221, // 259: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	175, // 292: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	...
	161, // 297: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	164, // 298: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	157, // 299: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	157, // 300: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	179, // 301: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	169, // 302: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	172, // 303: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	173, // 304: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	136, // 305: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	138, // 306: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	134, // 307: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	...
	142, // 310: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	144, // 311: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	146, // 312: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	177, // 313: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	183, // 314: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	187, // 315: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	190, // 316: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	192, // 317: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	195, // 318: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	200, // 319: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	198, // 320: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	195, // 321: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	203, // 322: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	205, // 323: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	207, // 324: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	210, // 325: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	216, // 326: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	217, // 327: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
