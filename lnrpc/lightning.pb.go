...
func (Failure_FailureCode) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{164, 0}
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x78, 0x0a, 0x18, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x72, 0x0a, 0x13, 0x42,
	...
	0x6f, 0x6e, 0x73, 0x2a, 0x7d, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x54, 0x79,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*DeleteAllPaymentsRequest)(nil),                            // 145: lnrpc.DeleteAllPaymentsRequest
...
var file_lightning_proto_depIdxs = []int32{
	...
	186, // 4: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	...
	187, // 8: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	188, // 9: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	189, // 27: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	190, // 32: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	...
	192, // 54: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	195, // 55: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	196, // 56: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	193, // 57: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	197, // 65: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	198, // 75: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	199, // 81: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	...
	200, // 86: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	...
	201, // 92: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	202, // 97: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	203, // 105: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	6,   // 106: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	204, // 107: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	182, // 115: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	...
	205, // 119: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	155, // 120: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	28,  // 121: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	160, // 122: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	...
	167, // 126: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	164, // 127: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	163, // 128: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	167, // 129: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	172, // 130: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	172, // 131: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	206, // 132: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	17,  // 133: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	183, // 134: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	185, // 135: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	153, // 136: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	153, // 137: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	191, // 140: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	191, // 141: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	194, // 142: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	191, // 143: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	191, // 144: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	153, // 148: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	120, // 149: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	153, // 150: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	153, // 151: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	153, // 152: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 153: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	...
	147, // 180: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	...
	133, // 185: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	138, // 186: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	137, // 187: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	140, // 188: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	151, // 189: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	143, // 190: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	145, // 191: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	116, // 192: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	118, // 193: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	121, // 194: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	110, // 195: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	102, // 196: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	122, // 197: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	124, // 198: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	126, // 199: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	149, // 200: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	154, // 201: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	157, // 202: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	159, // 203: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	162, // 204: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	165, // 205: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	166, // 206: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	168, // 207: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	170, // 208: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	173, // 209: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	175, // 210: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	177, // 211: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	180, // 212: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	...
	21,  // 215: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	32,  // 216: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	36,  // 217: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	38,  // 218: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	19,  // 219: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	34,  // 220: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	40,  // 221: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	42,  // 222: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	44,  // 223: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	46,  // 224: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	48,  // 225: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	61,  // 226: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	63,  // 227: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	65,  // 228: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	67,  // 229: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	93,  // 230: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	53,  // 231: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	95,  // 232: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	57,  // 233: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	28,  // 234: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	...
	26,  // 237: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	73,  // 238: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	148, // 239: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	24,  // 240: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	24,  // 241: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	24,  // 242: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	24,  // 243: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	...
	152, // 248: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	144, // 249: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	146, // 250: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	117, // 251: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	119, // 252: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	115, // 253: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	111, // 254: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	105, // 255: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	123, // 256: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	125, // 257: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	127, // 258: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	150, // 259: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	156, // 260: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	158, // 261: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	161, // 262: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	163, // 263: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	166, // 264: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	171, // 265: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	169, // 266: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	166, // 267: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	174, // 268: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	176, // 269: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	178, // 270: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	181, // 271: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	213, // [213:272] is the sub-list for method output_type
	154, // [154:213] is the sub-list for method input_type
...
func file_lightning_proto_init() {
	...
	file_lightning_proto_msgTypes[139].OneofWrappers = []interface{}{
