...
type OnionMessage struct {
	...
	// Onion is the raw serialized Sphinx onion packet containing the per-hop
...
func (x *OnionMessage) GetBlindingPoint() []byte {
	if x != nil {
...
func (x *SendOnionMessageRequest) GetBlindingPoint() []byte {
	if x != nil {
		return x.BlindingPoint
	}
	return nil
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x6f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x62, 0x6c, 0x69, 0x6e,
