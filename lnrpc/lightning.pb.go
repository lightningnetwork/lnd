...
var file_lightning_proto_msgTypes = make([]protoimpl.MessageInfo, 237)
var file_lightning_proto_goTypes = []any{
	...
	nil,                                                         // 230: lnrpc.SendRequest.DestCustomRecordsEntry
...
var file_lightning_proto_depIdxs = []int32{
	...
	230, // 7: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	...
	231, // 12: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	1,   // 13: lnrpc.EstimateFeeRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	43,  // 14: lnrpc.EstimateFeeRequest.inputs:type_name -> lnrpc.OutPoint
	43,  // 15: lnrpc.EstimateFeeResponse.inputs:type_name -> lnrpc.OutPoint
	232, // 16: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	43,  // 19: lnrpc.SendCoinsRequest.outpoints:type_name -> lnrpc.OutPoint
	31,  // 20: lnrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	2,   // 21: lnrpc.NewAddressRequest.type:type_name -> lnrpc.AddressType
	45,  // 22: lnrpc.ConnectPeerRequest.addr:type_name -> lnrpc.LightningAddress
	64,  // 23: lnrpc.Channel.pending_htlcs:type_name -> lnrpc.HTLC
	3,   // 24: lnrpc.Channel.commitment_type:type_name -> lnrpc.CommitmentType
	65,  // 25: lnrpc.Channel.local_constraints:type_name -> lnrpc.ChannelConstraints
	65,  // 26: lnrpc.Channel.remote_constraints:type_name -> lnrpc.ChannelConstraints
	66,  // 27: lnrpc.ListChannelsResponse.channels:type_name -> lnrpc.Channel
	69,  // 28: lnrpc.ListAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	12,  // 29: lnrpc.ChannelCloseSummary.close_type:type_name -> lnrpc.ChannelCloseSummary.ClosureType
	...
	73,  // 32: lnrpc.ChannelCloseSummary.resolutions:type_name -> lnrpc.Resolution
	...
	43,  // 35: lnrpc.Resolution.outpoint:type_name -> lnrpc.OutPoint
	72,  // 36: lnrpc.ClosedChannelsResponse.channels:type_name -> lnrpc.ChannelCloseSummary
	13,  // 37: lnrpc.Peer.sync_type:type_name -> lnrpc.Peer.SyncType
	233, // 38: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	77,  // 39: lnrpc.Peer.errors:type_name -> lnrpc.TimestampedError
	76,  // 40: lnrpc.ListPeersResponse.peers:type_name -> lnrpc.Peer
	14,  // 41: lnrpc.PeerEvent.type:type_name -> lnrpc.PeerEvent.EventType
	88,  // 42: lnrpc.GetInfoResponse.chains:type_name -> lnrpc.Chain
	234, // 43: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	235, // 44: lnrpc.GetDebugInfoResponse.config:type_name -> lnrpc.GetDebugInfoResponse.ConfigEntry
	42,  // 45: lnrpc.ChannelOpenUpdate.channel_point:type_name -> lnrpc.ChannelPoint
	90,  // 46: lnrpc.ChannelCloseUpdate.local_close_output:type_name -> lnrpc.CloseOutput
	90,  // 47: lnrpc.ChannelCloseUpdate.remote_close_output:type_name -> lnrpc.CloseOutput
	90,  // 48: lnrpc.ChannelCloseUpdate.additional_outputs:type_name -> lnrpc.CloseOutput
	42,  // 49: lnrpc.CloseChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	94,  // 50: lnrpc.CloseStatusUpdate.close_pending:type_name -> lnrpc.PendingUpdate
	91,  // 51: lnrpc.CloseStatusUpdate.chan_close:type_name -> lnrpc.ChannelCloseUpdate
	95,  // 52: lnrpc.CloseStatusUpdate.close_instant:type_name -> lnrpc.InstantUpdate
	98,  // 53: lnrpc.BatchOpenChannelRequest.channels:type_name -> lnrpc.BatchOpenChannel
	...
	94,  // 56: lnrpc.BatchOpenChannelResponse.pending_channels:type_name -> lnrpc.PendingUpdate
	106, // 57: lnrpc.OpenChannelRequest.funding_shim:type_name -> lnrpc.FundingShim
	3,   // 58: lnrpc.OpenChannelRequest.commitment_type:type_name -> lnrpc.CommitmentType
	43,  // 59: lnrpc.OpenChannelRequest.outpoints:type_name -> lnrpc.OutPoint
	94,  // 60: lnrpc.OpenStatusUpdate.chan_pending:type_name -> lnrpc.PendingUpdate
	89,  // 61: lnrpc.OpenStatusUpdate.chan_open:type_name -> lnrpc.ChannelOpenUpdate
	96,  // 62: lnrpc.OpenStatusUpdate.psbt_fund:type_name -> lnrpc.ReadyForPsbtFunding
	102, // 63: lnrpc.KeyDescriptor.key_loc:type_name -> lnrpc.KeyLocator
	42,  // 64: lnrpc.ChanPointShim.chan_point:type_name -> lnrpc.ChannelPoint
	103, // 65: lnrpc.ChanPointShim.local_key:type_name -> lnrpc.KeyDescriptor
	104, // 66: lnrpc.FundingShim.chan_point_shim:type_name -> lnrpc.ChanPointShim
	105, // 67: lnrpc.FundingShim.psbt_shim:type_name -> lnrpc.PsbtShim
	106, // 68: lnrpc.FundingTransitionMsg.shim_register:type_name -> lnrpc.FundingShim
	107, // 69: lnrpc.FundingTransitionMsg.shim_cancel:type_name -> lnrpc.FundingShimCancel
	108, // 70: lnrpc.FundingTransitionMsg.psbt_verify:type_name -> lnrpc.FundingPsbtVerify
	109, // 71: lnrpc.FundingTransitionMsg.psbt_finalize:type_name -> lnrpc.FundingPsbtFinalize
	237, // 72: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	240, // 73: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	241, // 74: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	238, // 75: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	66,  // 76: lnrpc.ChannelCommitUpdate.channel:type_name -> lnrpc.Channel
	66,  // 77: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	72,  // 78: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	42,  // 79: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	42,  // 80: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	94,  // 81: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	42,  // 82: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	42,  // 83: lnrpc.ChannelEventUpdate.channel_funding_timeout:type_name -> lnrpc.ChannelPoint
	116, // 84: lnrpc.ChannelEventUpdate.updated_channel:type_name -> lnrpc.ChannelCommitUpdate
	16,  // 85: lnrpc.ChannelEventUpdate.type:type_name -> lnrpc.ChannelEventUpdate.UpdateType
	242, // 86: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	121, // 87: lnrpc.ChannelBalanceResponse.local_balance:type_name -> lnrpc.Amount
	121, // 88: lnrpc.ChannelBalanceResponse.remote_balance:type_name -> lnrpc.Amount
	121, // 89: lnrpc.ChannelBalanceResponse.unsettled_local_balance:type_name -> lnrpc.Amount
	121, // 90: lnrpc.ChannelBalanceResponse.unsettled_remote_balance:type_name -> lnrpc.Amount
	121, // 91: lnrpc.ChannelBalanceResponse.pending_open_local_balance:type_name -> lnrpc.Amount
	121, // 92: lnrpc.ChannelBalanceResponse.pending_open_remote_balance:type_name -> lnrpc.Amount
	36,  // 93: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	126, // 94: lnrpc.QueryRoutesRequest.ignored_edges:type_name -> lnrpc.EdgeLocator
	125, // 95: lnrpc.QueryRoutesRequest.ignored_pairs:type_name -> lnrpc.NodePair
	243, // 96: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	156, // 97: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	157, // 98: lnrpc.QueryRoutesRequest.blinded_payment_paths:type_name -> lnrpc.BlindedPaymentPath
	10,  // 99: lnrpc.QueryRoutesRequest.dest_features:type_name -> lnrpc.FeatureBit
	131, // 100: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	129, // 101: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	130, // 102: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	244, // 103: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	128, // 104: lnrpc.Route.hops:type_name -> lnrpc.Hop
	134, // 105: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	138, // 106: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	135, // 107: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	245, // 108: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	246, // 109: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	247, // 110: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	136, // 111: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	136, // 112: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	248, // 113: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	137, // 114: lnrpc.ChannelEdge.auth_proof:type_name -> lnrpc.ChannelAuthProof
	134, // 115: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	138, // 116: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	7,   // 117: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	249, // 118: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	151, // 119: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	152, // 120: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	153, // 121: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	135, // 122: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	250, // 123: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	42,  // 124: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	136, // 125: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	42,  // 126: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	154, // 127: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	158, // 128: lnrpc.BlindedPaymentPath.blinded_path:type_name -> lnrpc.BlindedPath
	10,  // 129: lnrpc.BlindedPaymentPath.features:type_name -> lnrpc.FeatureBit
	159, // 130: lnrpc.BlindedPath.blinded_hops:type_name -> lnrpc.BlindedHop
	8,   // 131: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	156, // 132: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	17,  // 133: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	163, // 134: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	251, // 135: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	252, // 136: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	162, // 137: lnrpc.Invoice.blinded_path_config:type_name -> lnrpc.BlindedPathConfig
	8,   // 138: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	253, // 139: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	164, // 140: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	161, // 141: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	18,  // 142: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	173, // 143: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	9,   // 144: lnrpc.Payment.failure_reason:type_name -> lnrpc.PaymentFailureReason
	254, // 145: lnrpc.Payment.first_hop_custom_records:type_name -> lnrpc.Payment.FirstHopCustomRecordsEntry
	19,  // 146: lnrpc.HTLCAttempt.status:type_name -> lnrpc.HTLCAttempt.HTLCStatus
	131, // 147: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	217, // 148: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	172, // 149: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	42,  // 150: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	156, // 151: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	255, // 152: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	157, // 153: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	188, // 154: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	42,  // 155: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	190, // 156: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	43,  // 157: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	11,  // 158: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	192, // 159: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	195, // 160: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	42,  // 161: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	42,  // 162: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	42,  // 163: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	202, // 164: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	199, // 165: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	198, // 166: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	202, // 167: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	207, // 168: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	207, // 169: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	256, // 170: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 171: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	218, // 172: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	220, // 173: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	207, // 174: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	225, // 175: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	226, // 176: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	226, // 177: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	257, // 178: lnrpc.RPCMiddlewareRequest.metadata_pairs:type_name -> lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
	228, // 179: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	229, // 180: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	186, // 181: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	186, // 182: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	236, // 185: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	236, // 186: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	239, // 187: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	236, // 188: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	236, // 189: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	112, // 190: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	15,  // 191: lnrpc.PendingChannelsResponse.ForceClosedChannel.anchor:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel.AnchorState
	118, // 192: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	186, // 193: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	143, // 194: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	186, // 195: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	186, // 196: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	160, // 197: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	186, // 198: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	214, // 199: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	224, // 200: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry.value:type_name -> lnrpc.MetadataValues
	119, // 201: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	122, // 202: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	34,  // 203: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	46,  // 204: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	50,  // 205: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	52,  // 206: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	34,  // 207: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	48,  // 208: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	54,  // 209: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	56,  // 210: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	58,  // 211: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	60,  // 212: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	62,  // 213: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	78,  // 214: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	80,  // 215: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	82,  // 216: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	84,  // 217: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	86,  // 218: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	113, // 219: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	67,  // 220: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	115, // 221: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	74,  // 222: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	100, // 223: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	100, // 224: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	97,  // 225: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	110, // 226: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	41,  // 227: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	92,  // 228: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	180, // 229: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	37,  // 230: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	37,  // 231: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	39,  // 232: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	39,  // 233: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	161, // 234: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	167, // 235: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	166, // 236: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	169, // 237: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	170, // 238: lnrpc.Lightning.DeleteCanceledInvoice:input_type -> lnrpc.DelCanceledInvoiceReq
	184, // 239: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	174, // 240: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	176, // 241: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	177, // 242: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	139, // 243: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	141, // 244: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	144, // 245: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	132, // 246: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	124, // 247: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	145, // 248: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	147, // 249: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	149, // 250: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	182, // 251: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	187, // 252: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	191, // 253: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	194, // 254: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	197, // 255: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	200, // 256: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	201, // 257: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	203, // 258: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	205, // 259: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	208, // 260: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	210, // 261: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	212, // 262: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	215, // 263: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	221, // 264: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	227, // 265: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	25,  // 266: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	23,  // 267: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	29,  // 268: lnrpc.Lightning.SendOnionMessage:input_type -> lnrpc.SendOnionMessageRequest
	27,  // 269: lnrpc.Lightning.SubscribeOnionMessages:input_type -> lnrpc.SubscribeOnionMessagesRequest
	70,  // 270: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	21,  // 271: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	120, // 272: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	123, // 273: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	35,  // 274: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	47,  // 275: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	51,  // 276: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	53,  // 277: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	33,  // 278: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	49,  // 279: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	55,  // 280: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	57,  // 281: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	59,  // 282: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	61,  // 283: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	63,  // 284: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	79,  // 285: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	81,  // 286: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	83,  // 287: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	85,  // 288: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	87,  // 289: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	114, // 290: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	68,  // 291: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	117, // 292: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	75,  // 293: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	42,  // 294: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	101, // 295: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	99,  // 296: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	111, // 297: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	40,  // 298: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	93,  // 299: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	181, // 300: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	38,  // 301: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	38,  // 302: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	38,  // 303: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	38,  // 304: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	165, // 305: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	168, // 306: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	161, // 307: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	161, // 308: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	171, // 309: lnrpc.Lightning.DeleteCanceledInvoice:output_type -> lnrpc.DelCanceledInvoiceResp
	185, // 310: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	175, // 311: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	178, // 312: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	179, // 313: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	140, // 314: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	142, // 315: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	138, // 316: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	133, // 317: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	127, // 318: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	146, // 319: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	148, // 320: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	150, // 321: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	183, // 322: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	189, // 323: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	193, // 324: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	196, // 325: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	198, // 326: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	201, // 327: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	206, // 328: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	204, // 329: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	201, // 330: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	209, // 331: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	211, // 332: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	213, // 333: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	216, // 334: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	222, // 335: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	223, // 336: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	26,  // 337: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	24,  // 338: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	30,  // 339: lnrpc.Lightning.SendOnionMessage:output_type -> lnrpc.SendOnionMessageResponse
	28,  // 340: lnrpc.Lightning.SubscribeOnionMessages:output_type -> lnrpc.OnionMessage
	71,  // 341: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	22,  // 342: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	272, // [272:343] is the sub-list for method output_type
	201, // [201:272] is the sub-list for method input_type
