...
type GetTransactionRequest struct {
	...
	// The hash hex of the transaction to search.
	TxHash string `protobuf:"bytes,1,opt,name=tx_hash,json=txHash,proto3" json:"tx_hash,omitempty"`
}
...
func (x *TransactionDetail) GetTransaction() *Transaction {
	if x != nil {
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x22, 0x30, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x48, 0x61, 0x73, 0x68, 0x22, 0x74, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x09, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x49, 0x0a, 0x11, 0x54, 0x72,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4c, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x75, 0x74, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0xec, 0x04, 0x0a, 0x14, 0x43, 0x68,
	...
	0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x77, 0x61, 0x6e, 0x74, 0x73, 0x5f,
	0x7a, 0x65, 0x72, 0x6f, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0d, 0x77, 0x61, 0x6e, 0x74, 0x73, 0x5a, 0x65, 0x72, 0x6f, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x28,
	0x0a, 0x10, 0x77, 0x61, 0x6e, 0x74, 0x73, 0x5f, 0x73, 0x63, 0x69, 0x64, 0x5f, 0x61, 0x6c, 0x69,
	0x61, 0x73, 0x18, 0x10, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x77, 0x61, 0x6e, 0x74, 0x73, 0x53,
	0x63, 0x69, 0x64, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x22, 0x90, 0x03, 0x0a, 0x15, 0x43, 0x68, 0x61,
	...
	0x6d, 0x69, 0x6e, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x44, 0x65, 0x70, 0x74, 0x68, 0x12, 0x1b,
	0x0a, 0x09, 0x7a, 0x65, 0x72, 0x6f, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x08, 0x7a, 0x65, 0x72, 0x6f, 0x43, 0x6f, 0x6e, 0x66, 0x22, 0x9d, 0x01, 0x0a, 0x0c,
	...
	0x6e, 0x64, 0x65, 0x78, 0x22, 0x52, 0x0a, 0x10, 0x50, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*TransactionDetail)(nil),                                   // 31: lnrpc.TransactionDetail
...
var file_lightning_proto_depIdxs = []int32{
	...
	28,  // 5: lnrpc.TransactionDetail.transaction:type_name -> lnrpc.Transaction
	...
	89,  // 48: lnrpc.OpenStatusUpdate.chan_pending:type_name -> lnrpc.PendingUpdate
	85,  // 49: lnrpc.OpenStatusUpdate.chan_open:type_name -> lnrpc.ChannelOpenUpdate
	90,  // 50: lnrpc.OpenStatusUpdate.psbt_fund:type_name -> lnrpc.ReadyForPsbtFunding
	96,  // 51: lnrpc.KeyDescriptor.key_loc:type_name -> lnrpc.KeyLocator
	39,  // 52: lnrpc.ChanPointShim.chan_point:type_name -> lnrpc.ChannelPoint
	97,  // 53: lnrpc.ChanPointShim.local_key:type_name -> lnrpc.KeyDescriptor
	98,  // 54: lnrpc.FundingShim.chan_point_shim:type_name -> lnrpc.ChanPointShim
	99,  // 55: lnrpc.FundingShim.psbt_shim:type_name -> lnrpc.PsbtShim
	100, // 56: lnrpc.FundingTransitionMsg.shim_register:type_name -> lnrpc.FundingShim
	101, // 57: lnrpc.FundingTransitionMsg.shim_cancel:type_name -> lnrpc.FundingShimCancel
	102, // 58: lnrpc.FundingTransitionMsg.psbt_verify:type_name -> lnrpc.FundingPsbtVerify
	103, // 59: lnrpc.FundingTransitionMsg.psbt_finalize:type_name -> lnrpc.FundingPsbtFinalize
	...
	63,  // 64: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	69,  // 65: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	39,  // 66: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	39,  // 67: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	89,  // 68: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	39,  // 69: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	...
	114, // 72: lnrpc.ChannelBalanceResponse.local_balance:type_name -> lnrpc.Amount
	114, // 73: lnrpc.ChannelBalanceResponse.remote_balance:type_name -> lnrpc.Amount
	114, // 74: lnrpc.ChannelBalanceResponse.unsettled_local_balance:type_name -> lnrpc.Amount
	114, // 75: lnrpc.ChannelBalanceResponse.unsettled_remote_balance:type_name -> lnrpc.Amount
	114, // 76: lnrpc.ChannelBalanceResponse.pending_open_local_balance:type_name -> lnrpc.Amount
	114, // 77: lnrpc.ChannelBalanceResponse.pending_open_remote_balance:type_name -> lnrpc.Amount
	33,  // 78: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	119, // 79: lnrpc.QueryRoutesRequest.ignored_edges:type_name -> lnrpc.EdgeLocator
	118, // 80: lnrpc.QueryRoutesRequest.ignored_pairs:type_name -> lnrpc.NodePair
	226, // 81: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	148, // 82: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	9,   // 83: lnrpc.QueryRoutesRequest.dest_features:type_name -> lnrpc.FeatureBit
	124, // 84: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	122, // 85: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	123, // 86: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	227, // 87: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	121, // 88: lnrpc.Route.hops:type_name -> lnrpc.Hop
	127, // 89: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	130, // 90: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	128, // 91: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	...
	129, // 95: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	129, // 96: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	231, // 97: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	127, // 98: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	130, // 99: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	...
	143, // 102: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	144, // 103: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	145, // 104: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	128, // 105: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	233, // 106: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	39,  // 107: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	129, // 108: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	39,  // 109: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	146, // 110: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	7,   // 111: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	148, // 112: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	16,  // 113: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	151, // 114: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	...
	152, // 119: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	150, // 120: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	17,  // 121: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	159, // 122: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	124, // 125: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	202, // 126: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	158, // 127: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	39,  // 128: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	148, // 129: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	237, // 130: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	174, // 131: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	39,  // 132: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	40,  // 133: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	10,  // 134: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	177, // 135: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	180, // 136: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	39,  // 137: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	39,  // 138: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	39,  // 139: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	187, // 140: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	184, // 141: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	183, // 142: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	187, // 143: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	192, // 144: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	192, // 145: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	...
	203, // 148: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	205, // 149: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	192, // 150: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	209, // 151: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	210, // 152: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	210, // 153: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	212, // 154: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	213, // 155: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	172, // 156: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	172, // 157: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	106, // 165: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	111, // 167: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	172, // 168: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	135, // 169: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	172, // 170: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	172, // 171: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	149, // 172: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	172, // 173: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	199, // 174: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	112, // 175: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	115, // 176: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	29,  // 177: lnrpc.Lightning.GetTransaction:input_type -> lnrpc.GetTransactionRequest
	30,  // 178: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	...
	30,  // 182: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	...
	20,  // 242: lnrpc.Lightning.LookupHtlc:input_type -> lnrpc.LookupHtlcRequest
	113, // 243: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	116, // 244: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	31,  // 245: lnrpc.Lightning.GetTransaction:output_type -> lnrpc.TransactionDetail
