...
type PolicyUpdateRequest struct {
	...
	//	*PolicyUpdateRequest_FeeRate
	//	*PolicyUpdateRequest_FeeRatePpm
	Fee isPolicyUpdateRequest_Fee `protobuf_oneof:"fee"`
...
func (m *PolicyUpdateRequest) GetFee() isPolicyUpdateRequest_Fee {
	if m != nil {
		return m.Fee
	}
	return nil
...
func (x *PolicyUpdateRequest) GetFeeRate() float64 {
	if x, ok := x.GetFee().(*PolicyUpdateRequest_FeeRate); ok {
		return x.FeeRate
	}
	return 0
}
...
func (x *PolicyUpdateRequest) GetFeeRatePpm() uint32 {
	if x, ok := x.GetFee().(*PolicyUpdateRequest_FeeRatePpm); ok {
		return x.FeeRatePpm
	}
	return 0
}
...
type isPolicyUpdateRequest_Fee interface {
	isPolicyUpdateRequest_Fee()
}

type PolicyUpdateRequest_FeeRate struct {
	// The effective fee rate in milli-satoshis. The precision of this value
	// goes up to 6 decimal places, so 1e-6.
	FeeRate float64 `protobuf:"fixed64,4,opt,name=fee_rate,json=feeRate,proto3,oneof"`
}

type PolicyUpdateRequest_FeeRatePpm struct {
	// The effective fee rate in micro-satoshis.
	FeeRatePpm uint32 `protobuf:"varint,9,opt,name=fee_rate_ppm,json=feeRatePpm,proto3,oneof"`
}

func (*PolicyUpdateRequest_FeeRate) isPolicyUpdateRequest_Fee() {}

func (*PolicyUpdateRequest_FeeRatePpm) isPolicyUpdateRequest_Fee() {}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x53, 0x75, 0x6d, 0x22, 0x81, 0x03, 0x0a, 0x13, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	0x74, 0x12, 0x1b, 0x0a, 0x08, 0x66, 0x65, 0x65, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x01, 0x48, 0x01, 0x52, 0x07, 0x66, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x12, 0x22,
	0x0a, 0x0c, 0x66, 0x65, 0x65, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x5f, 0x70, 0x70, 0x6d, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x0d, 0x48, 0x01, 0x52, 0x0a, 0x66, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x50,
	...
	0x70, 0x65, 0x42, 0x05, 0x0a, 0x03, 0x66, 0x65, 0x65, 0x22, 0x8c, 0x01, 0x0a, 0x0c, 0x46, 0x61,
...
func file_lightning_proto_init() {
	...
	file_lightning_proto_msgTypes[147].OneofWrappers = []interface{}{
		...
		(*PolicyUpdateRequest_FeeRate)(nil),
		(*PolicyUpdateRequest_FeeRatePpm)(nil),
	}
