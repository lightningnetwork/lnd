...
var file_lightning_proto_rawDesc = []byte{
	...
	0x45, 0x52, 0x10, 0x04, 0x32, 0x8f, 0x26, 0x0a, 0x09, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x69,
...
var file_lightning_proto_msgTypes = make([]protoimpl.MessageInfo, 215)
var file_lightning_proto_goTypes = []interface{}{
	...
	nil, // 225: lnrpc.LightningNode.CustomRecordsEntry
	nil, // 226: lnrpc.RoutingPolicy.CustomRecordsEntry
	nil, // 227: lnrpc.ChannelEdge.CustomRecordsEntry
	nil, // 228: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	nil, // 229: lnrpc.NodeUpdate.FeaturesEntry
	nil, // 230: lnrpc.Invoice.FeaturesEntry
	nil, // 231: lnrpc.Invoice.AmpInvoiceStateEntry
	nil, // 232: lnrpc.InvoiceHTLC.CustomRecordsEntry
	nil, // 233: lnrpc.PayReq.FeaturesEntry
	nil, // 234: lnrpc.ListPermissionsResponse.MethodPermissionsEntry
}
var file_lightning_proto_depIdxs = []int32{
	...
	225, // 92: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	226, // 93: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	125, // 94: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	125, // 95: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	227, // 96: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	123, // 97: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	126, // 98: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	6,   // 99: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	228, // 100: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	139, // 101: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	140, // 102: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	141, // 103: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	124, // 104: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	229, // 105: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	35,  // 106: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	125, // 107: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	35,  // 108: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	142, // 109: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	7,   // 110: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	144, // 111: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	16,  // 112: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	147, // 113: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	230, // 114: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	231, // 115: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 116: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	232, // 117: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	148, // 118: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	146, // 119: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	17,  // 120: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	155, // 121: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	120, // 124: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	198, // 125: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	154, // 126: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	35,  // 127: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	144, // 128: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	233, // 129: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	170, // 130: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	35,  // 131: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	36,  // 132: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	10,  // 133: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	173, // 134: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	176, // 135: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	35,  // 136: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	35,  // 137: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	35,  // 138: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	183, // 139: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	180, // 140: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	179, // 141: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	183, // 142: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	188, // 143: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	188, // 144: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	234, // 145: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	19,  // 146: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	199, // 147: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	201, // 148: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	188, // 149: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	205, // 150: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	206, // 151: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	206, // 152: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	208, // 153: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	209, // 154: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	168, // 155: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	168, // 156: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	215, // 159: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	215, // 160: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	218, // 161: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	215, // 162: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	215, // 163: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	102, // 164: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	107, // 166: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	168, // 167: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	131, // 168: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	168, // 169: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	168, // 170: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	145, // 171: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	168, // 172: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	195, // 173: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	108, // 174: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	111, // 175: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	27,  // 176: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	39,  // 177: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	43,  // 178: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	45,  // 179: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	27,  // 180: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	41,  // 181: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	47,  // 182: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	49,  // 183: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	51,  // 184: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	53,  // 185: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	55,  // 186: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	71,  // 187: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	73,  // 188: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	75,  // 189: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	77,  // 190: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	103, // 191: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	60,  // 192: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	105, // 193: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	67,  // 194: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	90,  // 195: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	90,  // 196: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	87,  // 197: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	100, // 198: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	34,  // 199: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	83,  // 200: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	162, // 201: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	30,  // 202: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	30,  // 203: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	32,  // 204: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	32,  // 205: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	146, // 206: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	151, // 207: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	150, // 208: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	153, // 209: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	166, // 210: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	156, // 211: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	158, // 212: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	159, // 213: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	127, // 214: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	129, // 215: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	132, // 216: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	121, // 217: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	113, // 218: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	133, // 219: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	135, // 220: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	137, // 221: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	164, // 222: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	169, // 223: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	172, // 224: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	175, // 225: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	178, // 226: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	181, // 227: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	182, // 228: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	184, // 229: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	186, // 230: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	189, // 231: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	191, // 232: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	193, // 233: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	196, // 234: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	202, // 235: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	207, // 236: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	22,  // 237: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	20,  // 238: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	63,  // 239: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	109, // 240: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	112, // 241: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	28,  // 242: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	40,  // 243: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	44,  // 244: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	46,  // 245: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	26,  // 246: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	42,  // 247: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	48,  // 248: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	50,  // 249: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	52,  // 250: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	54,  // 251: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	56,  // 252: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	72,  // 253: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	74,  // 254: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	76,  // 255: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	78,  // 256: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	104, // 257: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	61,  // 258: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	106, // 259: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	68,  // 260: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	35,  // 261: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	91,  // 262: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	89,  // 263: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	101, // 264: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	33,  // 265: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	84,  // 266: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	163, // 267: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	31,  // 268: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	31,  // 269: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	31,  // 270: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	31,  // 271: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	149, // 272: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	152, // 273: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	146, // 274: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	146, // 275: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	167, // 276: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	157, // 277: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	160, // 278: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	161, // 279: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	128, // 280: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	130, // 281: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	126, // 282: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	122, // 283: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	116, // 284: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	134, // 285: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	136, // 286: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	138, // 287: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	165, // 288: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	171, // 289: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	174, // 290: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	177, // 291: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	179, // 292: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	182, // 293: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	187, // 294: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	185, // 295: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	182, // 296: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	190, // 297: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	192, // 298: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	194, // 299: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	197, // 300: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	203, // 301: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	204, // 302: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	64,  // 305: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	240, // [240:306] is the sub-list for method output_type
	174, // [174:240] is the sub-list for method input_type
