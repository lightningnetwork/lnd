...
type PendingChannelsResponse_PendingChannel struct {
	...
	CustomChannelData []byte `protobuf:"bytes,14,opt,name=custom_channel_data,json=customChannelData,proto3" json:"custom_channel_data,omitempty"`
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
