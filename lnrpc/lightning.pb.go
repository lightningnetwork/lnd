...
type FeeReportResponse struct {
	...
	// over the past 24 hrs. A negative amount is reported as zero. Deprecated,
	// use day_fee_sum_msat.
	//
	// Deprecated: Do not use.
	DayFeeSum uint64 `protobuf:"varint,2,opt,name=day_fee_sum,json=dayFeeSum,proto3" json:"day_fee_sum,omitempty"`
	// The total amount of fee revenue (in satoshis) the switch has collected
	// over the past 1 week. A negative amount is reported as zero. Deprecated,
	// use week_fee_sum_msat.
	//
	// Deprecated: Do not use.
	WeekFeeSum uint64 `protobuf:"varint,3,opt,name=week_fee_sum,json=weekFeeSum,proto3" json:"week_fee_sum,omitempty"`
	// The total amount of fee revenue (in satoshis) the switch has collected
	// over the past 1 month. A negative amount is reported as zero. Deprecated,
	// use month_fee_sum_msat.
	//
	// Deprecated: Do not use.
	MonthFeeSum uint64 `protobuf:"varint,4,opt,name=month_fee_sum,json=monthFeeSum,proto3" json:"month_fee_sum,omitempty"`
	// The total amount of fee revenue (in millisatoshis) the switch has
	// collected over the past 24 hrs. This value may be negative.
	DayFeeSumMsat int64 `protobuf:"varint,5,opt,name=day_fee_sum_msat,json=dayFeeSumMsat,proto3" json:"day_fee_sum_msat,omitempty"`
	// The total amount of fee revenue (in millisatoshis) the switch has
	// collected over the past 1 week. This value may be negative.
	WeekFeeSumMsat int64 `protobuf:"varint,6,opt,name=week_fee_sum_msat,json=weekFeeSumMsat,proto3" json:"week_fee_sum_msat,omitempty"`
	// The total amount of fee revenue (in millisatoshis) the switch has
	// collected over the past 1 month. This value may be negative.
	MonthFeeSumMsat int64 `protobuf:"varint,7,opt,name=month_fee_sum_msat,json=monthFeeSumMsat,proto3" json:"month_fee_sum_msat,omitempty"`
}
...
func (x *FeeReportResponse) GetDayFeeSumMsat() int64 {
	if x != nil {
		return x.DayFeeSumMsat
	}
	return 0
}

func (x *FeeReportResponse) GetWeekFeeSumMsat() int64 {
	if x != nil {
		return x.WeekFeeSumMsat
	}
	return 0
}

func (x *FeeReportResponse) GetMonthFeeSumMsat() int64 {
	if x != nil {
		return x.MonthFeeSumMsat
	}
	return 0
}
...
type ForwardingEvent struct {
	...
	// The total fee (in satoshis) that this payment circuit carried. A negative
	// amount is reported as zero. Deprecated, use fee_signed_msat.
	//
	// Deprecated: Do not use.
	Fee uint64 `protobuf:"varint,7,opt,name=fee,proto3" json:"fee,omitempty"`
	// The total fee (in milli-satoshis) that this payment circuit carried. A
	// negative amount is reported as zero. Deprecated, use fee_signed_msat.
	//
	// Deprecated: Do not use.
	FeeMsat uint64 `protobuf:"varint,8,opt,name=fee_msat,json=feeMsat,proto3" json:"fee_msat,omitempty"`
	// The total fee (in milli-satoshis) that this payment circuit carried. This
	// value may be negative.
	FeeSignedMsat int64 `protobuf:"varint,14,opt,name=fee_signed_msat,json=feeSignedMsat,proto3" json:"fee_signed_msat,omitempty"`
...
func (x *ForwardingEvent) GetFeeSignedMsat() int64 {
	if x != nil {
		return x.FeeSignedMsat
	}
	return 0
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x72, 0x4d, 0x69, 0x6c, 0x22, 0xc2, 0x02, 0x0a, 0x11, 0x46, 0x65, 0x65, 0x52, 0x65, 0x70, 0x6f,
	...
	,
	...
	0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x22, 0xb5, 0x03, 0x0a, 0x0f, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72,
	...
	0x74, 0x12, 0x14, 0x0a, 0x03, 0x66, 0x65, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x42, 0x02,
	0x18, 0x01, 0x52, 0x03, 0x66, 0x65, 0x65, 0x12, 0x1d, 0x0a, 0x08, 0x66, 0x65, 0x65, 0x5f, 0x6d,
	0x73, 0x61, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x42, 0x02, 0x18, 0x01, 0x52, 0x07, 0x66,
	0x65, 0x65, 0x4d, 0x73, 0x61, 0x74, 0x12, 0x26, 0x0a, 0x0f, 0x66, 0x65, 0x65, 0x5f, 0x73, 0x69,
	0x67, 0x6e, 0x65, 0x64, 0x5f, 0x6d, 0x73, 0x61, 0x74, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0d, 0x66, 0x65, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x4d, 0x73, 0x61, 0x74, 0x12, 0x1e,
