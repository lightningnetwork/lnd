...
var file_lightning_proto_rawDesc = []byte{
	...
	0xd9, 0x09, 0x0a, 0x07, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6d,
	...
	0x61, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x18, 0x1d, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x05, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x1a, 0x4b, 0x0a, 0x0d, 0x46, 0x65, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x24, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x6c, 0x6e,
	0x72, 0x70, 0x63, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c,
...
var file_lightning_proto_depIdxs = []int32{
	...
	223, // 36: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	224, // 41: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	225, // 42: lnrpc.GetDebugInfoResponse.config:type_name -> lnrpc.GetDebugInfoResponse.ConfigEntry
	...
	227, // 67: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	230, // 68: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	231, // 69: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	228, // 70: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	232, // 78: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	233, // 88: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	234, // 95: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	...
	235, // 100: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	236, // 101: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	237, // 102: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	...
	238, // 105: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	...
	239, // 109: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	240, // 114: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	156, // 125: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	241, // 126: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	242, // 127: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	8,   // 128: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	243, // 129: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	157, // 130: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	...
	164, // 133: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	208, // 137: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	163, // 138: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	...
	179, // 143: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	38,  // 144: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	181, // 145: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	...
	183, // 148: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	186, // 149: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	...
	193, // 153: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	190, // 154: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	189, // 155: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	193, // 156: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	198, // 157: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	198, // 158: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	...
	209, // 161: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	211, // 162: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	198, // 163: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	...
	218, // 167: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	219, // 168: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	177, // 169: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	177, // 170: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	226, // 173: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	226, // 174: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	229, // 175: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	226, // 176: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	226, // 177: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	177, // 181: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	137, // 182: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	177, // 183: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	177, // 184: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	154, // 185: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	177, // 186: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	205, // 187: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	...
	171, // 216: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	...
	160, // 222: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	159, // 223: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	162, // 224: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	175, // 225: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	165, // 226: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	167, // 227: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	168, // 228: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	...
	173, // 237: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	178, // 238: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	182, // 239: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	185, // 240: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	188, // 241: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	191, // 242: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	192, // 243: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	194, // 244: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	196, // 245: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	199, // 246: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	201, // 247: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	203, // 248: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	206, // 249: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	212, // 250: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	217, // 251: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	172, // 284: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	...
	158, // 289: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	161, // 290: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	...
	176, // 293: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	166, // 294: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	169, // 295: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	170, // 296: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	...
	174, // 305: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	180, // 306: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	184, // 307: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	187, // 308: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	189, // 309: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	192, // 310: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	197, // 311: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	195, // 312: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	192, // 313: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	200, // 314: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	202, // 315: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	204, // 316: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	207, // 317: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	213, // 318: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	214, // 319: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
