...
type Invoice struct {
	...
	// The number of routing hints the invoice should include. Poor channel
	// liquidity may result in more hints being added, lack of private channels
	// in less. The maximum is 20 hints.
	NumRouteHints int64 `protobuf:"varint,29,opt,name=num_route_hints,json=numRouteHints,proto3" json:"num_route_hints,omitempty"`
}
...
func (x *Invoice) GetNumRouteHints() int64 {
	if x != nil {
		return x.NumRouteHints
	}
	return 0
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x0b, 0x61, 0x6d, 0x74, 0x50, 0x61, 0x69, 0x64, 0x4d, 0x73, 0x61, 0x74, 0x22, 0xeb,
	...
	0x74, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x75, 0x6d, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f,
	0x68, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x6e, 0x75, 0x6d,
	0x52, 0x6f, 0x75, 0x74, 0x65, 0x48, 0x69, 0x6e, 0x74, 0x73, 0x1a, 0x4b, 0x0a, 0x0d, 0x46, 0x65,
