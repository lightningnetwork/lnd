...
var file_lightning_proto_goTypes = []any{
	...
	(*OnionMessageUpdate)(nil),                                  // 28: lnrpc.OnionMessageUpdate
	...
	nil,                                                         // 231: lnrpc.SendRequest.DestCustomRecordsEntry
	nil,                                                         // 232: lnrpc.EstimateFeeRequest.AddrToAmountEntry
	nil,                                                         // 233: lnrpc.SendManyRequest.AddrToAmountEntry
	nil,                                                         // 234: lnrpc.Peer.FeaturesEntry
	nil,                                                         // 235: lnrpc.GetInfoResponse.FeaturesEntry
	nil,                                                         // 236: lnrpc.GetDebugInfoResponse.ConfigEntry
	(*PendingChannelsResponse_PendingChannel)(nil),              // 237: lnrpc.PendingChannelsResponse.PendingChannel
	(*PendingChannelsResponse_PendingOpenChannel)(nil),          // 238: lnrpc.PendingChannelsResponse.PendingOpenChannel
	(*PendingChannelsResponse_WaitingCloseChannel)(nil),         // 239: lnrpc.PendingChannelsResponse.WaitingCloseChannel
	(*PendingChannelsResponse_Commitments)(nil),                 // 240: lnrpc.PendingChannelsResponse.Commitments
	(*PendingChannelsResponse_ClosedChannel)(nil),               // 241: lnrpc.PendingChannelsResponse.ClosedChannel
	(*PendingChannelsResponse_ForceClosedChannel)(nil),          // 242: lnrpc.PendingChannelsResponse.ForceClosedChannel
	nil, // 243: lnrpc.WalletBalanceResponse.AccountBalanceEntry
	nil, // 244: lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	nil, // 245: lnrpc.Hop.CustomRecordsEntry
	nil, // 246: lnrpc.LightningNode.FeaturesEntry
	nil, // 247: lnrpc.LightningNode.CustomRecordsEntry
	nil, // 248: lnrpc.RoutingPolicy.CustomRecordsEntry
	nil, // 249: lnrpc.ChannelEdge.CustomRecordsEntry
	nil, // 250: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	nil, // 251: lnrpc.NodeUpdate.FeaturesEntry
	nil, // 252: lnrpc.Invoice.FeaturesEntry
	nil, // 253: lnrpc.Invoice.AmpInvoiceStateEntry
	nil, // 254: lnrpc.InvoiceHTLC.CustomRecordsEntry
	nil, // 255: lnrpc.Payment.FirstHopCustomRecordsEntry
	nil, // 256: lnrpc.PayReq.FeaturesEntry
	nil, // 257: lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	nil, // 258: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
}
var file_lightning_proto_depIdxs = []int32{
	...
	32,  // 5: lnrpc.Transaction.output_details:type_name -> lnrpc.OutputDetail
	44,  // 6: lnrpc.Transaction.previous_outpoints:type_name -> lnrpc.PreviousOutPoint
	33,  // 7: lnrpc.TransactionDetails.transactions:type_name -> lnrpc.Transaction
	36,  // 8: lnrpc.SendRequest.fee_limit:type_name -> lnrpc.FeeLimit
	231, // 9: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	10,  // 10: lnrpc.SendRequest.dest_features:type_name -> lnrpc.FeatureBit
	131, // 11: lnrpc.SendResponse.payment_route:type_name -> lnrpc.Route
	...
	232, // 14: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	1,   // 15: lnrpc.EstimateFeeRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	43,  // 16: lnrpc.EstimateFeeRequest.inputs:type_name -> lnrpc.OutPoint
	43,  // 17: lnrpc.EstimateFeeResponse.inputs:type_name -> lnrpc.OutPoint
	233, // 18: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	43,  // 21: lnrpc.SendCoinsRequest.outpoints:type_name -> lnrpc.OutPoint
	31,  // 22: lnrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	2,   // 23: lnrpc.NewAddressRequest.type:type_name -> lnrpc.AddressType
	45,  // 24: lnrpc.ConnectPeerRequest.addr:type_name -> lnrpc.LightningAddress
	64,  // 25: lnrpc.Channel.pending_htlcs:type_name -> lnrpc.HTLC
	3,   // 26: lnrpc.Channel.commitment_type:type_name -> lnrpc.CommitmentType
	65,  // 27: lnrpc.Channel.local_constraints:type_name -> lnrpc.ChannelConstraints
	65,  // 28: lnrpc.Channel.remote_constraints:type_name -> lnrpc.ChannelConstraints
	66,  // 29: lnrpc.ListChannelsResponse.channels:type_name -> lnrpc.Channel
	69,  // 30: lnrpc.ListAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	12,  // 31: lnrpc.ChannelCloseSummary.close_type:type_name -> lnrpc.ChannelCloseSummary.ClosureType
	...
	73,  // 34: lnrpc.ChannelCloseSummary.resolutions:type_name -> lnrpc.Resolution
	...
	43,  // 37: lnrpc.Resolution.outpoint:type_name -> lnrpc.OutPoint
	72,  // 38: lnrpc.ClosedChannelsResponse.channels:type_name -> lnrpc.ChannelCloseSummary
	13,  // 39: lnrpc.Peer.sync_type:type_name -> lnrpc.Peer.SyncType
	234, // 40: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	77,  // 41: lnrpc.Peer.errors:type_name -> lnrpc.TimestampedError
	76,  // 42: lnrpc.ListPeersResponse.peers:type_name -> lnrpc.Peer
	14,  // 43: lnrpc.PeerEvent.type:type_name -> lnrpc.PeerEvent.EventType
	88,  // 44: lnrpc.GetInfoResponse.chains:type_name -> lnrpc.Chain
	235, // 45: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	236, // 46: lnrpc.GetDebugInfoResponse.config:type_name -> lnrpc.GetDebugInfoResponse.ConfigEntry
	42,  // 47: lnrpc.ChannelOpenUpdate.channel_point:type_name -> lnrpc.ChannelPoint
	90,  // 48: lnrpc.ChannelCloseUpdate.local_close_output:type_name -> lnrpc.CloseOutput
	90,  // 49: lnrpc.ChannelCloseUpdate.remote_close_output:type_name -> lnrpc.CloseOutput
	90,  // 50: lnrpc.ChannelCloseUpdate.additional_outputs:type_name -> lnrpc.CloseOutput
	42,  // 51: lnrpc.CloseChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	94,  // 52: lnrpc.CloseStatusUpdate.close_pending:type_name -> lnrpc.PendingUpdate
	91,  // 53: lnrpc.CloseStatusUpdate.chan_close:type_name -> lnrpc.ChannelCloseUpdate
	95,  // 54: lnrpc.CloseStatusUpdate.close_instant:type_name -> lnrpc.InstantUpdate
	98,  // 55: lnrpc.BatchOpenChannelRequest.channels:type_name -> lnrpc.BatchOpenChannel
	1,   // 56: lnrpc.BatchOpenChannelRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	3,   // 57: lnrpc.BatchOpenChannel.commitment_type:type_name -> lnrpc.CommitmentType
	94,  // 58: lnrpc.BatchOpenChannelResponse.pending_channels:type_name -> lnrpc.PendingUpdate
	106, // 59: lnrpc.OpenChannelRequest.funding_shim:type_name -> lnrpc.FundingShim
	3,   // 60: lnrpc.OpenChannelRequest.commitment_type:type_name -> lnrpc.CommitmentType
	43,  // 61: lnrpc.OpenChannelRequest.outpoints:type_name -> lnrpc.OutPoint
	94,  // 62: lnrpc.OpenStatusUpdate.chan_pending:type_name -> lnrpc.PendingUpdate
	89,  // 63: lnrpc.OpenStatusUpdate.chan_open:type_name -> lnrpc.ChannelOpenUpdate
	96,  // 64: lnrpc.OpenStatusUpdate.psbt_fund:type_name -> lnrpc.ReadyForPsbtFunding
	102, // 65: lnrpc.KeyDescriptor.key_loc:type_name -> lnrpc.KeyLocator
	42,  // 66: lnrpc.ChanPointShim.chan_point:type_name -> lnrpc.ChannelPoint
	103, // 67: lnrpc.ChanPointShim.local_key:type_name -> lnrpc.KeyDescriptor
	104, // 68: lnrpc.FundingShim.chan_point_shim:type_name -> lnrpc.ChanPointShim
	105, // 69: lnrpc.FundingShim.psbt_shim:type_name -> lnrpc.PsbtShim
	106, // 70: lnrpc.FundingTransitionMsg.shim_register:type_name -> lnrpc.FundingShim
	107, // 71: lnrpc.FundingTransitionMsg.shim_cancel:type_name -> lnrpc.FundingShimCancel
	108, // 72: lnrpc.FundingTransitionMsg.psbt_verify:type_name -> lnrpc.FundingPsbtVerify
	109, // 73: lnrpc.FundingTransitionMsg.psbt_finalize:type_name -> lnrpc.FundingPsbtFinalize
	238, // 74: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	241, // 75: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	242, // 76: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	239, // 77: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	66,  // 78: lnrpc.ChannelCommitUpdate.channel:type_name -> lnrpc.Channel
	66,  // 79: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	72,  // 80: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	42,  // 81: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	42,  // 82: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	94,  // 83: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	42,  // 84: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	42,  // 85: lnrpc.ChannelEventUpdate.channel_funding_timeout:type_name -> lnrpc.ChannelPoint
	116, // 86: lnrpc.ChannelEventUpdate.updated_channel:type_name -> lnrpc.ChannelCommitUpdate
	16,  // 87: lnrpc.ChannelEventUpdate.type:type_name -> lnrpc.ChannelEventUpdate.UpdateType
	243, // 88: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	121, // 89: lnrpc.ChannelBalanceResponse.local_balance:type_name -> lnrpc.Amount
	121, // 90: lnrpc.ChannelBalanceResponse.remote_balance:type_name -> lnrpc.Amount
	121, // 91: lnrpc.ChannelBalanceResponse.unsettled_local_balance:type_name -> lnrpc.Amount
	121, // 92: lnrpc.ChannelBalanceResponse.unsettled_remote_balance:type_name -> lnrpc.Amount
	121, // 93: lnrpc.ChannelBalanceResponse.pending_open_local_balance:type_name -> lnrpc.Amount
	121, // 94: lnrpc.ChannelBalanceResponse.pending_open_remote_balance:type_name -> lnrpc.Amount
	36,  // 95: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	126, // 96: lnrpc.QueryRoutesRequest.ignored_edges:type_name -> lnrpc.EdgeLocator
	125, // 97: lnrpc.QueryRoutesRequest.ignored_pairs:type_name -> lnrpc.NodePair
	244, // 98: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	156, // 99: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	157, // 100: lnrpc.QueryRoutesRequest.blinded_payment_paths:type_name -> lnrpc.BlindedPaymentPath
	10,  // 101: lnrpc.QueryRoutesRequest.dest_features:type_name -> lnrpc.FeatureBit
	131, // 102: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	129, // 103: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	130, // 104: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	245, // 105: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	128, // 106: lnrpc.Route.hops:type_name -> lnrpc.Hop
	134, // 107: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	138, // 108: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	135, // 109: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	246, // 110: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	247, // 111: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	248, // 112: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	136, // 113: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	136, // 114: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	249, // 115: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	137, // 116: lnrpc.ChannelEdge.auth_proof:type_name -> lnrpc.ChannelAuthProof
	134, // 117: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	138, // 118: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	7,   // 119: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	250, // 120: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	151, // 121: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	152, // 122: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	153, // 123: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	135, // 124: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	251, // 125: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	42,  // 126: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	136, // 127: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	42,  // 128: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	154, // 129: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	158, // 130: lnrpc.BlindedPaymentPath.blinded_path:type_name -> lnrpc.BlindedPath
	10,  // 131: lnrpc.BlindedPaymentPath.features:type_name -> lnrpc.FeatureBit
	159, // 132: lnrpc.BlindedPath.blinded_hops:type_name -> lnrpc.BlindedHop
	8,   // 133: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	156, // 134: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	17,  // 135: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	163, // 136: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	252, // 137: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	253, // 138: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	162, // 139: lnrpc.Invoice.blinded_path_config:type_name -> lnrpc.BlindedPathConfig
	8,   // 140: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	254, // 141: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	164, // 142: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	161, // 143: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	18,  // 144: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	173, // 145: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	9,   // 146: lnrpc.Payment.failure_reason:type_name -> lnrpc.PaymentFailureReason
	255, // 147: lnrpc.Payment.first_hop_custom_records:type_name -> lnrpc.Payment.FirstHopCustomRecordsEntry
	19,  // 148: lnrpc.HTLCAttempt.status:type_name -> lnrpc.HTLCAttempt.HTLCStatus
	131, // 149: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	217, // 150: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	172, // 151: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	42,  // 152: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	156, // 153: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	256, // 154: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	157, // 155: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	188, // 156: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	42,  // 157: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	190, // 158: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	43,  // 159: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	11,  // 160: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	192, // 161: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	195, // 162: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	42,  // 163: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	42,  // 164: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	42,  // 165: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	202, // 166: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	199, // 167: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	198, // 168: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	202, // 169: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	207, // 170: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	207, // 171: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	257, // 172: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 173: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	218, // 174: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	220, // 175: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	207, // 176: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	225, // 177: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	226, // 178: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	226, // 179: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	258, // 180: lnrpc.RPCMiddlewareRequest.metadata_pairs:type_name -> lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
	228, // 181: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	229, // 182: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	186, // 183: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	186, // 184: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	4,   // 185: lnrpc.PendingChannelsResponse.PendingChannel.initiator:type_name -> lnrpc.Initiator
	3,   // 186: lnrpc.PendingChannelsResponse.PendingChannel.commitment_type:type_name -> lnrpc.CommitmentType
	237, // 187: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	237, // 188: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	240, // 189: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	237, // 190: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	237, // 191: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	112, // 192: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	15,  // 193: lnrpc.PendingChannelsResponse.ForceClosedChannel.anchor:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel.AnchorState
	118, // 194: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	186, // 195: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	143, // 196: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	186, // 197: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	186, // 198: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	160, // 199: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	186, // 200: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	214, // 201: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	224, // 202: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry.value:type_name -> lnrpc.MetadataValues
	119, // 203: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	122, // 204: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	34,  // 205: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	46,  // 206: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	50,  // 207: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	52,  // 208: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	34,  // 209: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	48,  // 210: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	54,  // 211: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	56,  // 212: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	58,  // 213: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	60,  // 214: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	62,  // 215: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	78,  // 216: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	80,  // 217: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	82,  // 218: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	84,  // 219: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	86,  // 220: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	113, // 221: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	67,  // 222: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	115, // 223: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	74,  // 224: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	100, // 225: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	100, // 226: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	97,  // 227: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	110, // 228: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	41,  // 229: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	92,  // 230: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	180, // 231: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	37,  // 232: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	37,  // 233: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	39,  // 234: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	39,  // 235: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	161, // 236: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	167, // 237: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	166, // 238: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	169, // 239: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	170, // 240: lnrpc.Lightning.DeleteCanceledInvoice:input_type -> lnrpc.DelCanceledInvoiceReq
	184, // 241: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	174, // 242: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	176, // 243: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	177, // 244: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	139, // 245: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	141, // 246: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	144, // 247: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	132, // 248: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	124, // 249: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	145, // 250: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	147, // 251: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	149, // 252: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	182, // 253: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	187, // 254: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	191, // 255: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	194, // 256: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	197, // 257: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	200, // 258: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	201, // 259: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	203, // 260: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	205, // 261: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	208, // 262: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	210, // 263: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	212, // 264: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	215, // 265: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	221, // 266: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	227, // 267: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	25,  // 268: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	23,  // 269: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	29,  // 270: lnrpc.Lightning.SendOnionMessage:input_type -> lnrpc.SendOnionMessageRequest
	27,  // 271: lnrpc.Lightning.SubscribeOnionMessages:input_type -> lnrpc.SubscribeOnionMessagesRequest
	70,  // 272: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	21,  // 273: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	120, // 274: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	123, // 275: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	35,  // 276: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	47,  // 277: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	51,  // 278: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	53,  // 279: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	33,  // 280: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	49,  // 281: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	55,  // 282: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	57,  // 283: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	59,  // 284: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	61,  // 285: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	63,  // 286: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	79,  // 287: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	81,  // 288: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	83,  // 289: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	85,  // 290: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	87,  // 291: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	114, // 292: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	68,  // 293: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	117, // 294: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	75,  // 295: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	42,  // 296: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	101, // 297: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	99,  // 298: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	111, // 299: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	40,  // 300: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	93,  // 301: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	181, // 302: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	38,  // 303: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	38,  // 304: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	38,  // 305: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	38,  // 306: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	165, // 307: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	168, // 308: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	161, // 309: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	161, // 310: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	171, // 311: lnrpc.Lightning.DeleteCanceledInvoice:output_type -> lnrpc.DelCanceledInvoiceResp
	185, // 312: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	175, // 313: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	178, // 314: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	179, // 315: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	140, // 316: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	142, // 317: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	138, // 318: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	133, // 319: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	127, // 320: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	146, // 321: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	148, // 322: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	150, // 323: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	183, // 324: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	189, // 325: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	193, // 326: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	196, // 327: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	198, // 328: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	201, // 329: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	206, // 330: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	204, // 331: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	201, // 332: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	209, // 333: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	211, // 334: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	213, // 335: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	216, // 336: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	222, // 337: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	223, // 338: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	26,  // 339: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	24,  // 340: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	30,  // 341: lnrpc.Lightning.SendOnionMessage:output_type -> lnrpc.SendOnionMessageResponse
	28,  // 342: lnrpc.Lightning.SubscribeOnionMessages:output_type -> lnrpc.OnionMessageUpdate
	71,  // 343: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	22,  // 344: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
