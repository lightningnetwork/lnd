...
var file_lightning_proto_depIdxs = []int32{
	...
	183, // 144: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	41,  // 145: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	11,  // 146: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	185, // 147: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	188, // 148: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	40,  // 149: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	40,  // 150: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	40,  // 151: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	195, // 152: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	192, // 153: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	191, // 154: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	195, // 155: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	200, // 156: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	200, // 157: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	247, // 158: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 159: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	211, // 160: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	213, // 161: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	200, // 162: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	217, // 163: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	218, // 164: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	218, // 165: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	220, // 166: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	221, // 167: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	179, // 168: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 169: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	228, // 172: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	228, // 173: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	231, // 174: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	228, // 175: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	228, // 176: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	110, // 177: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	115, // 179: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	179, // 180: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	139, // 181: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	179, // 182: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 183: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	156, // 184: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	179, // 185: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	207, // 186: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	116, // 187: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	119, // 188: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	32,  // 189: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	44,  // 190: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	48,  // 191: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	50,  // 192: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	32,  // 193: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	46,  // 194: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	52,  // 195: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	54,  // 196: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	56,  // 197: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	58,  // 198: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	60,  // 199: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	76,  // 200: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	78,  // 201: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	80,  // 202: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	82,  // 203: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	84,  // 204: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	111, // 205: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	65,  // 206: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	113, // 207: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	72,  // 208: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	98,  // 209: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	98,  // 210: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	95,  // 211: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	108, // 212: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	39,  // 213: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	90,  // 214: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	173, // 215: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	35,  // 216: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	35,  // 217: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	37,  // 218: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	37,  // 219: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	157, // 220: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	162, // 221: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	161, // 222: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	164, // 223: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	177, // 224: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	167, // 225: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	169, // 226: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	170, // 227: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	135, // 228: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	137, // 229: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	140, // 230: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	129, // 231: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	121, // 232: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	141, // 233: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	143, // 234: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	145, // 235: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	175, // 236: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	180, // 237: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	184, // 238: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	187, // 239: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	190, // 240: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	193, // 241: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	194, // 242: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	196, // 243: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	198, // 244: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	201, // 245: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	203, // 246: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	205, // 247: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	208, // 248: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	214, // 249: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	219, // 250: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	27,  // 251: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	25,  // 252: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	68,  // 253: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	23,  // 254: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	21,  // 255: lnrpc.Lightning.Quiesce:input_type -> lnrpc.QuiescenceRequest
	117, // 256: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	120, // 257: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	33,  // 258: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	45,  // 259: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	49,  // 260: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	51,  // 261: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	31,  // 262: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	47,  // 263: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	53,  // 264: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	55,  // 265: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	57,  // 266: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	59,  // 267: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	61,  // 268: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	77,  // 269: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	79,  // 270: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	81,  // 271: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	83,  // 272: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	85,  // 273: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	112, // 274: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	66,  // 275: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	114, // 276: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	73,  // 277: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	40,  // 278: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	99,  // 279: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	97,  // 280: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	109, // 281: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	38,  // 282: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	91,  // 283: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	174, // 284: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	36,  // 285: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	36,  // 286: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	36,  // 287: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	36,  // 288: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	160, // 289: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	163, // 290: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	157, // 291: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	157, // 292: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	178, // 293: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	168, // 294: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	171, // 295: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	172, // 296: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	136, // 297: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	138, // 298: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	134, // 299: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	130, // 300: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	124, // 301: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	142, // 302: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	144, // 303: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	146, // 304: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	176, // 305: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	182, // 306: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	186, // 307: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	189, // 308: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	191, // 309: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	194, // 310: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	199, // 311: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	197, // 312: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	194, // 313: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	202, // 314: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	204, // 315: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	206, // 316: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	209, // 317: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	215, // 318: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	216, // 319: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	28,  // 320: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	26,  // 321: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	69,  // 322: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	24,  // 323: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	22,  // 324: lnrpc.Lightning.Quiesce:output_type -> lnrpc.QuiescenceResponse
	256, // [256:325] is the sub-list for method output_type
	187, // [187:256] is the sub-list for method input_type
