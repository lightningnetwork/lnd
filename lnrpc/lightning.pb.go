...
var file_lightning_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x72, 0x22, 0xbb, 0x03, 0x0a, 0x0d, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x50,
	...
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x21, 0x0a, 0x0c,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x1a,
	...
	0x01, 0x22, 0x8d, 0x09, 0x0a, 0x07, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x2e, 0x0a,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x3f, 0x0a, 0x10,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x32,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x43,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0x52, 0x0e, 0x63,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0x22, 0x8b, 0x06,
	...
	0x71, 0x75, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0xb4, 0x03, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*ChannelUpdate2)(nil),                                      // 208: lnrpc.ChannelUpdate2
...
var file_lightning_proto_depIdxs = []int32{
	...
	221, // 13: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	222, // 32: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	223, // 37: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	224, // 38: lnrpc.GetDebugInfoResponse.config:type_name -> lnrpc.GetDebugInfoResponse.ConfigEntry
	...
	226, // 62: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	229, // 63: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	230, // 64: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	227, // 65: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	231, // 73: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	232, // 83: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	233, // 90: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	...
	234, // 95: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	235, // 96: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	236, // 97: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	...
	237, // 100: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	...
	238, // 104: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	239, // 109: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	240, // 121: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	241, // 122: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 123: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	242, // 124: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	243, // 136: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	...
	244, // 152: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	...
	208, // 155: lnrpc.Failure.channel_update_2:type_name -> lnrpc.ChannelUpdate2
	210, // 156: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	196, // 157: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	214, // 158: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	215, // 159: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	215, // 160: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	217, // 161: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	218, // 162: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	...
	225, // 167: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	225, // 168: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	228, // 169: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	225, // 170: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	225, // 171: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	211, // 244: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	216, // 245: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
