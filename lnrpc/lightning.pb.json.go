...
func RegisterLightningJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["lnrpc.Lightning.ListPaymentDuplicates"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ListPaymentDuplicatesRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.ListPaymentDuplicates(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.ListAllPaymentDuplicates"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ListAllPaymentDuplicatesRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.ListAllPaymentDuplicates(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
