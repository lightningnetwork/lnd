...
type RouteFeeRequest struct {
	...
	// Optional route hints to reach the destination through private channels.
	RouteHints []*lnrpc.RouteHint `protobuf:"bytes,3,rep,name=route_hints,json=routeHints,proto3" json:"route_hints,omitempty"`
}
...
func (x *RouteFeeRequest) GetRouteHints() []*lnrpc.RouteHint {
	if x != nil {
		return x.RouteHints
	}
	return nil
...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x22, 0x71, 0x0a,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x6d, 0x74, 0x53, 0x61, 0x74, 0x12, 0x31, 0x0a,
	...
	0x22, 0x64, 0x0a, 0x10, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x46, 0x65, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x5f,
	0x66, 0x65, 0x65, 0x5f, 0x6d, 0x73, 0x61, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e,
	0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x46, 0x65, 0x65, 0x4d, 0x73, 0x61, 0x74, 0x12, 0x26,
	0x0a, 0x0f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x64, 0x65, 0x6c, 0x61,
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x74, 0x69, 0x6d, 0x65, 0x4c, 0x6f, 0x63,
	0x6b, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x22, 0x7f, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x6f,
	...
	0x54, 0x65, 0x6d, 0x70, 0x45, 0x72, 0x72, 0x22, 0x5b, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x54,
...
var file_routerrpc_router_proto_depIdxs = []int32{
	...
	49, // 3: routerrpc.RouteFeeRequest.route_hints:type_name -> lnrpc.RouteHint
	51, // 4: routerrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	52, // 5: routerrpc.SendToRouteResponse.failure:type_name -> lnrpc.Failure
	...
	51, // 15: routerrpc.BuildRouteResponse.route:type_name -> lnrpc.Route
	...
	53, // 25: routerrpc.LinkFailEvent.wire_failure:type_name -> lnrpc.Failure.FailureCode
	...
	54, // 28: routerrpc.PaymentStatus.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	53, // 33: routerrpc.ForwardHtlcInterceptResponse.failure_code:type_name -> lnrpc.Failure.FailureCode
	55, // 34: routerrpc.UpdateChanStatusRequest.chan_point:type_name -> lnrpc.ChannelPoint
	...
	56, // 54: routerrpc.Router.SendPaymentV2:output_type -> lnrpc.Payment
	56, // 55: routerrpc.Router.TrackPaymentV2:output_type -> lnrpc.Payment
	56, // 56: routerrpc.Router.TrackPayments:output_type -> lnrpc.Payment
	...
	54, // 59: routerrpc.Router.SendToRouteV2:output_type -> lnrpc.HTLCAttempt
