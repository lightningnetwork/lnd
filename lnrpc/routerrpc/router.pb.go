...
type NodeHistory struct {
	...
	//*
	//Estimation of success probability for node pairs that are not in the pairs
	//list.
...
type PairHistory struct {
	/// The lexicographically smaller node pubkey of the pair.
	NodeA []byte `protobuf:"bytes,1,opt,name=node_a,proto3" json:"node_a,omitempty"`
	/// The lexicographically larger node pubkey of the pair.
	NodeB []byte `protobuf:"bytes,2,opt,name=node_b,proto3" json:"node_b,omitempty"`
...
var fileDescriptor_7a0613f69d37b0a5 = []byte{
	...
	,
}
