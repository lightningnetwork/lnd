...
func (r *RouterBackend) MarshalHTLCAttempt(
	htlc pymtpkgDB.HTLCAttempt) (*lnrpc.HTLCAttempt, error) {
...
// representation.
func marshallHtlcFailure(failure *pymtpkgDB.HTLCFailInfo) (*lnrpc.Failure,
	error) {
...
func (r *RouterBackend) MarshallPayment(payment *pymtpkgDB.MPPayment) (
	*lnrpc.Payment, error) {
...
// by the RPC.
func convertPaymentStatus(dbStatus pymtpkgDB.PaymentStatus, useInit bool) (
	lnrpc.Payment_PaymentStatus, error) {

	switch dbStatus {
	case pymtpkgDB.StatusInitiated:
	...
	case pymtpkgDB.StatusInFlight:
		return lnrpc.Payment_IN_FLIGHT, nil

	case pymtpkgDB.StatusSucceeded:
		return lnrpc.Payment_SUCCEEDED, nil

	case pymtpkgDB.StatusFailed:
...
// type.
func marshallPaymentFailureReason(reason *pymtpkgDB.FailureReason) (
