...
type Invoice struct {
	...
	// / Whether this invoice has been canceled
	Canceled bool `protobuf:"varint,16,opt,name=canceled" json:"canceled,omitempty"`
}
...
func (m *Invoice) GetCanceled() bool {
	if m != nil {
		return m.Canceled
	}
	return false
...
func (m *CancelInvoiceResponse) Reset()                    { *m = CancelInvoiceResponse{} }
func (m *CancelInvoiceResponse) String() string            { return proto.CompactTextString(m) }
func (*CancelInvoiceResponse) ProtoMessage()               {}
func (*CancelInvoiceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{106} }
...
func init() {
	...
	proto.RegisterType((*CancelInvoiceResponse)(nil), "lnrpc.CancelInvoiceResponse")
...
type LightningClient interface {
	...
	// The passed payment hash *must* be exactly 32 bytes, if not, an error is
	// returned.
	CancelInvoice(ctx context.Context, in *PaymentHash, opts ...grpc.CallOption) (*CancelInvoiceResponse, error)
	// *
...
func (c *lightningClient) CancelInvoice(ctx context.Context, in *PaymentHash, opts ...grpc.CallOption) (*CancelInvoiceResponse, error) {
...
type LightningServer interface {
	...
	// The passed payment hash *must* be exactly 32 bytes, if not, an error is
	// returned.
	CancelInvoice(context.Context, *PaymentHash) (*CancelInvoiceResponse, error)
	// *
	// SubscribeInvoices returns a uni-directional stream (sever -> client) for
	// notifying the client of newly added/settled invoices.
...
func _Lightning_CancelInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).CancelInvoice(ctx, req.(*PaymentHash))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
	...
	0x05, 0x2a, 0xab, 0x72, 0xbf, 0x57, 0x81, 0x86, 0x54, 0xc1, 0xbb, 0x83, 0x21, 0x97, 0x37, 0x19,
	...
	0x6b, 0xcd, 0x28, 0xf4, 0x6f, 0x55, 0xa1, 0x61, 0xc0, 0x28, 0xcd, 0x43, 0x1c, 0x70, 0x6f, 0x10,
	...
	0xef, 0x5b, 0xf2, 0x03, 0xd5, 0xc4, 0x2f, 0xc8, 0xdb, 0xc7, 0x01, 0xcd, 0x51, 0xc5, 0x07, 0xf4,
	...
	0x22, 0x33, 0x35, 0x5a, 0x02, 0xbe, 0x2b, 0xd1, 0xcc, 0xa4, 0xd4, 0x0c, 0x93, 0xe2, 0x7e, 0xab,
	...
	0xe4, 0xb5, 0x87, 0xbd, 0xa4, 0xb5, 0x57, 0x59, 0x52, 0xf7, 0xfb, 0x0e, 0x2c, 0xed, 0x45, 0x93,
	0x3d, 0x79, 0x67, 0x4f, 0x82, 0xa0, 0x73, 0xcf, 0x54, 0xf1, 0x05, 0xb7, 0xf9, 0xa5, 0xb6, 0x76,
	0x25, 0x6f, 0x6b, 0x7f, 0x11, 0x5e, 0xa3, 0x68, 0x40, 0x1c, 0x4d, 0xa2, 0x18, 0x85, 0xd1, 0x1f,
	...
	,
}
