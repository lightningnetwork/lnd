...
type Hop struct {
	...
	// / delta calculated by subtracting current block height from the expiry
	ExpiryDelta      uint32 `protobuf:"varint,3,opt,name=expiry_delta" json:"expiry_delta,omitempty"`
	AmtToForward     int64  `protobuf:"varint,4,opt,name=amt_to_forward" json:"amt_to_forward,omitempty"`
	...
	AmtToForwardMsat int64  `protobuf:"varint,7,opt,name=amt_to_forward_msat" json:"amt_to_forward_msat,omitempty"`
	FeeMsat          int64  `protobuf:"varint,8,opt,name=fee_msat" json:"fee_msat,omitempty"`
}
...
func (m *Hop) GetExpiryDelta() uint32 {
	if m != nil {
...
type Route struct {
	...
	// *
	// delta calculated by subtracting current block height from the time_lock
	TotalTimeLockDelta uint32 `protobuf:"varint,2,opt,name=total_time_lock_delta" json:"total_time_lock_delta,omitempty"`
	// *
	// The sum of the fees paid at each hop within the final route.  In the case
	// of a one-hop payment, this value will be zero as we don't need to pay a fee
	// it ourself.
	TotalFees int64 `protobuf:"varint,3,opt,name=total_fees" json:"total_fees,omitempty"`
	// *
	...
	TotalAmt int64 `protobuf:"varint,4,opt,name=total_amt" json:"total_amt,omitempty"`
	// *
	// Contains details concerning the specific forwarding details at each hop.
	Hops []*Hop `protobuf:"bytes,5,rep,name=hops" json:"hops,omitempty"`
	// *
	// The total fees in millisatoshis.
	TotalFeesMsat int64 `protobuf:"varint,6,opt,name=total_fees_msat" json:"total_fees_msat,omitempty"`
	// *
	// The total amount in millisatoshis.
	TotalAmtMsat int64 `protobuf:"varint,7,opt,name=total_amt_msat" json:"total_amt_msat,omitempty"`
}
...
func (m *Route) GetTotalTimeLockDelta() uint32 {
	if m != nil {
		return m.TotalTimeLockDelta
	}
	return 0
}
...
var fileDescriptor0 = []byte{
	...
	,
}
