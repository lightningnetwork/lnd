...
type SendRequest struct {
	...
	// Maximum fee in satoshis, specified as:
	// max_fee_satoshis: maximum fee in satoshis, or
	// max_fee_ratio: maximum ratio of fees / payment amount.
	// Routes with fees greater than max_fee will be abandoned
	// during path finding.
	//
	// Types that are valid to be assigned to MaxFee:
	//	*SendRequest_MaxFeeSatoshis
	//	*SendRequest_MaxFeeRatio
	MaxFee isSendRequest_MaxFee `protobuf_oneof:"max_fee"`
}
...
type isSendRequest_MaxFee interface {
	isSendRequest_MaxFee()
}

type SendRequest_MaxFeeSatoshis struct {
	MaxFeeSatoshis int64 `protobuf:"varint,7,opt,name=max_fee_satoshis,oneof"`
}
type SendRequest_MaxFeeRatio struct {
	MaxFeeRatio float64 `protobuf:"fixed64,8,opt,name=max_fee_ratio,oneof"`
}

func (*SendRequest_MaxFeeSatoshis) isSendRequest_MaxFee() {}
func (*SendRequest_MaxFeeRatio) isSendRequest_MaxFee()    {}

func (m *SendRequest) GetMaxFee() isSendRequest_MaxFee {
	if m != nil {
		return m.MaxFee
	}
	return nil
...
func (m *SendRequest) GetMaxFeeSatoshis() int64 {
	if x, ok := m.GetMaxFee().(*SendRequest_MaxFeeSatoshis); ok {
		return x.MaxFeeSatoshis
	}
	return 0
}

func (m *SendRequest) GetMaxFeeRatio() float64 {
	if x, ok := m.GetMaxFee().(*SendRequest_MaxFeeRatio); ok {
...
func (*SendRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _SendRequest_OneofMarshaler, _SendRequest_OneofUnmarshaler, _SendRequest_OneofSizer, []interface{}{
		(*SendRequest_MaxFeeSatoshis)(nil),
		(*SendRequest_MaxFeeRatio)(nil),
	}
}
...
func _SendRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*SendRequest)
	// max_fee
	switch x := m.MaxFee.(type) {
	case *SendRequest_MaxFeeSatoshis:
		b.EncodeVarint(7<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.MaxFeeSatoshis))
	case *SendRequest_MaxFeeRatio:
		b.EncodeVarint(8<<3 | proto.WireFixed64)
		b.EncodeFixed64(math.Float64bits(x.MaxFeeRatio))
	case nil:
	default:
		return fmt.Errorf("SendRequest.MaxFee has unexpected type %T", x)
	}
	return nil
}
...
func _SendRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*SendRequest)
	switch tag {
	case 7: // max_fee.max_fee_satoshis
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.MaxFee = &SendRequest_MaxFeeSatoshis{int64(x)}
		return true, err
	case 8: // max_fee.max_fee_ratio
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed64()
		m.MaxFee = &SendRequest_MaxFeeRatio{math.Float64frombits(x)}
		return true, err
	default:
		return false, nil
	}
...
func _SendRequest_OneofSizer(msg proto.Message) (n int) {
	...
	case *SendRequest_MaxFeeSatoshis:
		...
		n += proto.SizeVarint(uint64(x.MaxFeeSatoshis))
	case *SendRequest_MaxFeeRatio:
...
var fileDescriptor0 = []byte{
	...
	,
}
