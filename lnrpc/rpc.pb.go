...
type Payment struct {
	...
	// value. This allows callers to catch up on any events they missed while they
	// weren't connected to the streaming RPC.
	AddIndex uint64 `protobuf:"varint,7,opt,name=add_index" json:"add_index,omitempty"`
}
...
func (*PaymentSubscription) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{92} }

func (m *PaymentSubscription) GetAddIndex() uint64 {
	if m != nil {
		return m.AddIndex
	}
	return 0
...
type LightningClient interface {
	...
	// *
	// SubscribePayments returns a uni-directional stream (sever -> client) for
	// notifying the client of newly added payments. The caller can
	// optionally specify the add_index. If the add_index is specified, then we'll
	// first start by sending add payment events for all payments with an add_index
	// greater than the specified value.  If add_index field is not set, then we'll
	// only send out the latest added events.
	SubscribePayments(ctx context.Context, in *PaymentSubscription, opts ...grpc.CallOption) (Lightning_SubscribePaymentsClient, error)
	// *
...
func (c *lightningClient) SubscribePayments(ctx context.Context, in *PaymentSubscription, opts ...grpc.CallOption) (Lightning_SubscribePaymentsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Lightning_serviceDesc.Streams[6], c.cc, "/lnrpc.Lightning/SubscribePayments", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningSubscribePaymentsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Lightning_SubscribePaymentsClient interface {
	Recv() (*Payment, error)
	grpc.ClientStream
}

type lightningSubscribePaymentsClient struct {
	grpc.ClientStream
}

func (x *lightningSubscribePaymentsClient) Recv() (*Payment, error) {
	m := new(Payment)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type LightningServer interface {
	...
	// greater than the specified value.  If add_index field is not set, then we'll
	// only send out the latest added events.
	SubscribePayments(*PaymentSubscription, Lightning_SubscribePaymentsServer) error
	// *
	// DeleteAllPayments deletes all outgoing payments from DB.
...
func _Lightning_SubscribePayments_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PaymentSubscription)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LightningServer).SubscribePayments(m, &lightningSubscribePaymentsServer{stream})
}

type Lightning_SubscribePaymentsServer interface {
	Send(*Payment) error
	grpc.ServerStream
}

type lightningSubscribePaymentsServer struct {
	grpc.ServerStream
}

func (x *lightningSubscribePaymentsServer) Send(m *Payment) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _Lightning_SubscribePayments_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
