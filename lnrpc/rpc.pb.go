...
type ChannelReportsRequest struct {
	//
...
func (m *ChannelReportsRequest) Reset()         { *m = ChannelReportsRequest{} }
func (m *ChannelReportsRequest) String() string { return proto.CompactTextString(m) }
func (*ChannelReportsRequest) ProtoMessage()    {}
func (*ChannelReportsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{136}
}

func (m *ChannelReportsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChannelReportsRequest.Unmarshal(m, b)
}
func (m *ChannelReportsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ChannelReportsRequest.Marshal(b, m, deterministic)
}
func (m *ChannelReportsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChannelReportsRequest.Merge(m, src)
}
func (m *ChannelReportsRequest) XXX_Size() int {
	return xxx_messageInfo_ChannelReportsRequest.Size(m)
}
func (m *ChannelReportsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ChannelReportsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ChannelReportsRequest proto.InternalMessageInfo

func (m *ChannelReportsRequest) GetStartTime() uint64 {
	if m != nil {
		return m.StartTime
	}
	return 0
...
func (m *ChannelReportsRequest) GetEndTime() uint64 {
	if m != nil {
		return m.EndTime
	}
	return 0
...
type ChannelReportsResponse struct {
	//
	//ChannelReport is a set of channel reports for all the channels that
	//forwarded htlcs the relevant period.
	Reports              []*ChannelReport `protobuf:"bytes,1,rep,name=reports,json=channel_report,proto3" json:"reports,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *ChannelReportsResponse) Reset()         { *m = ChannelReportsResponse{} }
func (m *ChannelReportsResponse) String() string { return proto.CompactTextString(m) }
func (*ChannelReportsResponse) ProtoMessage()    {}
func (*ChannelReportsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{137}
}

func (m *ChannelReportsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChannelReportsResponse.Unmarshal(m, b)
}
func (m *ChannelReportsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ChannelReportsResponse.Marshal(b, m, deterministic)
}
func (m *ChannelReportsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChannelReportsResponse.Merge(m, src)
}
func (m *ChannelReportsResponse) XXX_Size() int {
	return xxx_messageInfo_ChannelReportsResponse.Size(m)
}
func (m *ChannelReportsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ChannelReportsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ChannelReportsResponse proto.InternalMessageInfo

func (m *ChannelReportsResponse) GetReports() []*ChannelReport {
	if m != nil {
		return m.Reports
	}
	return nil
...
type ChannelReport struct {
	//
	//OutPoint is the funding outpoint of the channel this report has
	//been generated for.
	ChannelOutpoint *OutPoint `protobuf:"bytes,1,opt,name=channel_outpoint,proto3" json:"channel_outpoint,omitempty"`
	//
	//Uptime is the amount of time in seconds that the remote peer for this
	//channel was observed as being online for.
	UptimeSeconds int64 `protobuf:"varint,2,opt,name=uptime_seconds,proto3" json:"uptime_seconds,omitempty"`
	//
	//Monitored since is the time (unix epoch offset in seconds) from which the
	//channel's uptime was first calculated. If this value is zero, the channel's
	//uptime was not monitored.
	MonitoredSince int64 `protobuf:"varint,3,opt,name=monitored_since,proto3" json:"monitored_since,omitempty"`
	//
	//Monitored until is the time (unix epoch offset in seconds) that the
	//channel's uptime was monitored until. If this value is zero, the channel's
	//uptime was not monitored.
	MonitoredUntil int64 `protobuf:"varint,4,opt,name=monitored_until,proto3" json:"monitored_until,omitempty"`
	//
	//Revenue reports provide the revenue that the channel has generated
	//through forwarding htlcs. They are provided per partner channel, as
	//htlcs are forwarded by pairs of channels.
	RevenueReports       []*RevenueReport `protobuf:"bytes,5,rep,name=revenue_reports,proto3" json:"revenue_reports,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ChannelReport) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChannelReport.Unmarshal(m, b)
}
...
func (m *ChannelReport) XXX_Size() int {
	return xxx_messageInfo_ChannelReport.Size(m)
}
...
func (m *ChannelReport) GetChannelOutpoint() *OutPoint {
	if m != nil {
		return m.ChannelOutpoint
	}
	return nil
}

func (m *ChannelReport) GetUptimeSeconds() int64 {
	if m != nil {
...
func (m *ChannelReport) GetMonitoredSince() int64 {
	if m != nil {
		return m.MonitoredSince
	}
	return 0
}

func (m *ChannelReport) GetMonitoredUntil() int64 {
	if m != nil {
		return m.MonitoredUntil
	}
	return 0
}

func (m *ChannelReport) GetRevenueReports() []*RevenueReport {
	if m != nil {
		return m.RevenueReports
	}
	return nil
}

type RevenueReport struct {
	// OutPoint channel is funcing outpoing the channel that this revenue was
	// generated with.
	PairChannel *OutPoint `protobuf:"bytes,1,opt,name=pair_channel,proto3" json:"pair_channel,omitempty"`
	//
	...
	AmountOutgoingMsat int64 `protobuf:"varint,2,opt,name=amount_outgoing_msat,proto3" json:"amount_outgoing_msat,omitempty"`
	//
	...
	//forwards.
	FeesOutgoingMsat int64 `protobuf:"varint,3,opt,name=fees_outgoing_msat,proto3" json:"fees_outgoing_msat,omitempty"`
	//
	...
	AmountIncomingMsat int64 `protobuf:"varint,4,opt,name=amount_incoming_msat,proto3" json:"amount_incoming_msat,omitempty"`
	//
	...
	//forwards.
	FeesIncomingMsat     int64    `protobuf:"varint,5,opt,name=fees_incoming_msat,proto3" json:"fees_incoming_msat,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RevenueReport) GetPairChannel() *OutPoint {
	if m != nil {
		return m.PairChannel
	}
	return nil
}

func (m *RevenueReport) GetAmountOutgoingMsat() int64 {
	if m != nil {
...
func (m *RevenueReport) GetFeesOutgoingMsat() int64 {
	if m != nil {
...
func (m *RevenueReport) GetAmountIncomingMsat() int64 {
	if m != nil {
...
func (m *RevenueReport) GetFeesIncomingMsat() int64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ChannelReportsRequest)(nil), "lnrpc.ChannelReportsRequest")
	proto.RegisterType((*ChannelReportsResponse)(nil), "lnrpc.ChannelReportsResponse")
	proto.RegisterType((*ChannelReport)(nil), "lnrpc.ChannelReport")
	proto.RegisterType((*RevenueReport)(nil), "lnrpc.RevenueReport")
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type LightningClient interface {
	...
	//* lncli: `channelrevenue`
	//ChannelReports returns a report on all channels that forwarded htlcs over
	//the period queried. The report contains details of the channel's revenue
	//earned over the period. If available, the channel's remote peer's uptime is
	//also reported.
	ChannelReports(ctx context.Context, in *ChannelReportsRequest, opts ...grpc.CallOption) (*ChannelReportsResponse, error)
}
...
func (c *lightningClient) ChannelReports(ctx context.Context, in *ChannelReportsRequest, opts ...grpc.CallOption) (*ChannelReportsResponse, error) {
	out := new(ChannelReportsResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/ChannelReports", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LightningServer interface {
	...
	//earned over the period. If available, the channel's remote peer's uptime is
	//also reported.
	ChannelReports(context.Context, *ChannelReportsRequest) (*ChannelReportsResponse, error)
}
...
func _Lightning_ChannelReports_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChannelReportsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).ChannelReports(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/ChannelReports",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).ChannelReports(ctx, req.(*ChannelReportsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChannelReports",
			Handler:    _Lightning_ChannelReports_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
