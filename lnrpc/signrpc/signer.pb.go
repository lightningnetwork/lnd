...
type SignMessageReq struct {
	...
	KeyLoc *KeyLocator `protobuf:"bytes,2,opt,name=key_loc,json=keyLoc,proto3" json:"key_loc,omitempty"`
	// Whether message should be hashed (SHA256) before being signed.
	NoHashing            bool     `protobuf:"varint,3,opt,name=no_hashing,json=noHashing,proto3" json:"no_hashing,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SignMessageReq) GetNoHashing() bool {
	if m != nil {
		return m.NoHashing
	}
	return false
...
var fileDescriptor_4ecd772f6c7ffacf = []byte{
	...
	,
}
