...
const file_signrpc_signer_proto_rawDesc = "" +
	...
	"\x0fhave_all_nonces\x18\x01 \x01(\bR\rhaveAllNonces\"s\n" +
	...
	"\x16MUSIG2_VERSION_V100RC2\x10\x022\xdb\x06\n" +
	"\x06Signer\x124\n" +
	...
	"\x14MuSig2RegisterNonces\x12$.signrpc.MuSig2RegisterNoncesRequest\x1a%.signrpc.MuSig2RegisterNoncesResponse\x12E\n" +
	"\n" +
