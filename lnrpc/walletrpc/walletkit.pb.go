...
type MsgSignatureType int32

const (
	// The legacy signature format initially used by Bitcoin Core but never
	// fully standardized in a BIP.
	MsgSignatureType_MSG_SIGNATURE_TYPE_LEGACY MsgSignatureType = 0
	// The 'simple' variant of the BIP-0322 generic message signature
	// specification, compatible with native SegWit address types, such as
	// P2WPKH, P2WSH, P2TR.
	MsgSignatureType_MSG_SIGNATURE_TYPE_BIP0322_SIMPLE MsgSignatureType = 1
	// The 'full' variant of the BIP-0322 generic message signature
	// specification, compatible with legacy (P2PKH, P2SH), compatibility
	// (NP2WPKH, NP2WSH) or time lock based script (P2SH, P2WSH) address types.
	MsgSignatureType_MSG_SIGNATURE_TYPE_BIP0322_FULL MsgSignatureType = 2
	// The 'proof of funds' variant of the BIP-0322 generic message signature
	// specification, supports the same address types as the 'full' variant but
	// can include additional UTXOs for which spendability should be attested.
	MsgSignatureType_MSG_SIGNATURE_TYPE_BIP0322_POF MsgSignatureType = 3
)

// Enum value maps for MsgSignatureType.
var (
	MsgSignatureType_name = map[int32]string{
		0: "MSG_SIGNATURE_TYPE_LEGACY",
		1: "MSG_SIGNATURE_TYPE_BIP0322_SIMPLE",
		2: "MSG_SIGNATURE_TYPE_BIP0322_FULL",
		3: "MSG_SIGNATURE_TYPE_BIP0322_POF",
	}
	MsgSignatureType_value = map[string]int32{
		"MSG_SIGNATURE_TYPE_LEGACY":         0,
		"MSG_SIGNATURE_TYPE_BIP0322_SIMPLE": 1,
		"MSG_SIGNATURE_TYPE_BIP0322_FULL":   2,
		"MSG_SIGNATURE_TYPE_BIP0322_POF":    3,
	}
)

func (x MsgSignatureType) Enum() *MsgSignatureType {
	p := new(MsgSignatureType)
	*p = x
	return p
}

func (x MsgSignatureType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MsgSignatureType) Descriptor() protoreflect.EnumDescriptor {
	return file_walletrpc_walletkit_proto_enumTypes[1].Descriptor()
}

func (MsgSignatureType) Type() protoreflect.EnumType {
	return &file_walletrpc_walletkit_proto_enumTypes[1]
}

func (x MsgSignatureType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MsgSignatureType.Descriptor instead.
func (MsgSignatureType) EnumDescriptor() ([]byte, []int) {
...
type SignMessageWithAddrRequest struct {
	...
	// Use the new, BIP-0322 standardized signature format that is compatible
	// with any address type but might be less widely adopted by verifiers.
	Bip322        bool `protobuf:"varint,3,opt,name=bip322,proto3" json:"bip322,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SignMessageWithAddrRequest) GetBip322() bool {
	if x != nil {
		return x.Bip322
	}
	return false
...
type SignMessageWithAddrResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The compact ECDSA signature or BIP-0322 signature for the given message
	// encoded in base64.
...
type VerifyMessageWithAddrRequest struct {
	...
	// base64.
	Msg []byte `protobuf:"bytes,1,opt,name=msg,proto3" json:"msg,omitempty"`
	// The compact ECDSA signature or BIP-0322 signature to be verified over the
	// given message, encoded in base64.
...
type MsgSignatureTimeConstraints struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Indicates that a time lock constraint was used in the signature. One or
	// both of the fields below are non-zero.
	Constrained bool `protobuf:"varint,1,opt,name=constrained,proto3" json:"constrained,omitempty"`
	// Indicates the LockTime value that must be satisfied for the witness stack
	// of a signature to be valid.
	ValidAtTime uint32 `protobuf:"varint,2,opt,name=valid_at_time,json=validAtTime,proto3" json:"valid_at_time,omitempty"`
	// Indicates the Sequence value that must be satisfied for the witness
	// stack of a signature to be valid.
	ValidAtAge    uint32 `protobuf:"varint,3,opt,name=valid_at_age,json=validAtAge,proto3" json:"valid_at_age,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MsgSignatureTimeConstraints) Reset() {
	*x = MsgSignatureTimeConstraints{}
	mi := &file_walletrpc_walletkit_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MsgSignatureTimeConstraints) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgSignatureTimeConstraints) ProtoMessage() {}

func (x *MsgSignatureTimeConstraints) ProtoReflect() protoreflect.Message {
	mi := &file_walletrpc_walletkit_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MsgSignatureTimeConstraints.ProtoReflect.Descriptor instead.
func (*MsgSignatureTimeConstraints) Descriptor() ([]byte, []int) {
	return file_walletrpc_walletkit_proto_rawDescGZIP(), []int{22}
}

func (x *MsgSignatureTimeConstraints) GetConstrained() bool {
	if x != nil {
...
func (x *MsgSignatureTimeConstraints) GetValidAtTime() uint32 {
	if x != nil {
...
func (x *MsgSignatureTimeConstraints) GetValidAtAge() uint32 {
	if x != nil {
		return x.ValidAtAge
	}
	return 0
...
type VerifyMessageWithAddrResponse struct {
	...
	// The pubkey recovered from the legacy compact ECDSA signature. This is not
	// set for BIP-0322 signatures.
	Pubkey []byte `protobuf:"bytes,2,opt,name=pubkey,proto3" json:"pubkey,omitempty"`
	// The type of signature that was detected.
	SignatureType MsgSignatureType `protobuf:"varint,3,opt,name=signature_type,json=signatureType,proto3,enum=walletrpc.MsgSignatureType" json:"signature_type,omitempty"`
	// The optional time constraints that might apply to a BIP-0322 signature.
	// This will only ever be set on a BIP-0322 'full' or 'proof of funds' type
	// signature that was created for a scripted address that uses LockTime or
	// Sequence check opcodes. A verifier must decide themselves if they want to
	// accept such a time or age-based constraint on a signature. lnd does not
	// interpret these values, as checking the signature is a fully offline
	// operation.
	TimeConstraints *MsgSignatureTimeConstraints `protobuf:"bytes,4,opt,name=time_constraints,json=timeConstraints,proto3" json:"time_constraints,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *VerifyMessageWithAddrResponse) GetSignatureType() MsgSignatureType {
	if x != nil {
		return x.SignatureType
	}
	return MsgSignatureType_MSG_SIGNATURE_TYPE_LEGACY
}

func (x *VerifyMessageWithAddrResponse) GetTimeConstraints() *MsgSignatureTimeConstraints {
	if x != nil {
		return x.TimeConstraints
	}
	return nil
}
...
const file_walletrpc_walletkit_proto_rawDesc = "" +
	...
	"\x04addr\x18\x03 \x01(\tR\x04addr\"\x85\x01\n" +
	"\x1bMsgSignatureTimeConstraints\x12 \n" +
	"\vconstrained\x18\x01 \x01(\bR\vconstrained\x12\"\n" +
	"\rvalid_at_time\x18\x02 \x01(\rR\vvalidAtTime\x12 \n" +
	"\fvalid_at_age\x18\x03 \x01(\rR\n" +
	"validAtAge\"\xe4\x01\n" +
	"\x1dVerifyMessageWithAddrResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x16\n" +
	"\x06pubkey\x18\x02 \x01(\fR\x06pubkey\x12B\n" +
	"\x0esignature_type\x18\x03 \x01(\x0e2\x1b.walletrpc.MsgSignatureTypeR\rsignatureType\x12Q\n" +
	"\x10time_constraints\x18\x04 \x01(\v2&.walletrpc.MsgSignatureTimeConstraintsR\x0ftimeConstraints\"\xe4\x01\n" +
	...
	"\x0eTAPROOT_PUBKEY\x10\x04*\xa1\x01\n" +
	"\x10MsgSignatureType\x12\x1d\n" +
	"\x19MSG_SIGNATURE_TYPE_LEGACY\x10\x00\x12%\n" +
	"!MSG_SIGNATURE_TYPE_BIP0322_SIMPLE\x10\x01\x12#\n" +
	"\x1fMSG_SIGNATURE_TYPE_BIP0322_FULL\x10\x02\x12\"\n" +
	"\x1eMSG_SIGNATURE_TYPE_BIP0322_POF\x10\x03*\xb7\f\n" +
...
var file_walletrpc_walletkit_proto_goTypes = []any{
	...
	(MsgSignatureType)(0),                     // 1: walletrpc.MsgSignatureType
	(WitnessType)(0),                          // 2: walletrpc.WitnessType
	(ChangeAddressType)(0),                    // 3: walletrpc.ChangeAddressType
	...
	(*MsgSignatureTimeConstraints)(nil),       // 26: walletrpc.MsgSignatureTimeConstraints
	...
	(*BumpForceCloseFeeRequest)(nil),          // 49: walletrpc.BumpForceCloseFeeRequest
	(*BumpForceCloseFeeResponse)(nil),         // 50: walletrpc.BumpForceCloseFeeResponse
	(*ListSweepsRequest)(nil),                 // 51: walletrpc.ListSweepsRequest
	(*ListSweepsResponse)(nil),                // 52: walletrpc.ListSweepsResponse
	(*LabelTransactionRequest)(nil),           // 53: walletrpc.LabelTransactionRequest
	(*LabelTransactionResponse)(nil),          // 54: walletrpc.LabelTransactionResponse
	(*FundPsbtRequest)(nil),                   // 55: walletrpc.FundPsbtRequest
	(*FundPsbtResponse)(nil),                  // 56: walletrpc.FundPsbtResponse
	(*TxTemplate)(nil),                        // 57: walletrpc.TxTemplate
	(*PsbtCoinSelect)(nil),                    // 58: walletrpc.PsbtCoinSelect
	(*UtxoLease)(nil),                         // 59: walletrpc.UtxoLease
	(*SignPsbtRequest)(nil),                   // 60: walletrpc.SignPsbtRequest
	(*SignPsbtResponse)(nil),                  // 61: walletrpc.SignPsbtResponse
	(*FinalizePsbtRequest)(nil),               // 62: walletrpc.FinalizePsbtRequest
	(*FinalizePsbtResponse)(nil),              // 63: walletrpc.FinalizePsbtResponse
	(*ListLeasesRequest)(nil),                 // 64: walletrpc.ListLeasesRequest
	(*ListLeasesResponse)(nil),                // 65: walletrpc.ListLeasesResponse
...
var file_walletrpc_walletkit_proto_depIdxs = []int32{
	...
	1,  // 10: walletrpc.VerifyMessageWithAddrResponse.signature_type:type_name -> walletrpc.MsgSignatureType
	26, // 11: walletrpc.VerifyMessageWithAddrResponse.time_constraints:type_name -> walletrpc.MsgSignatureTimeConstraints
	0,  // 12: walletrpc.ImportAccountRequest.address_type:type_name -> walletrpc.AddressType
	13, // 13: walletrpc.ImportAccountResponse.account:type_name -> walletrpc.Account
	...
	70, // 19: walletrpc.SendOutputsRequest.outputs:type_name -> signrpc.TxOut
	71, // 20: walletrpc.SendOutputsRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	69, // 21: walletrpc.PendingSweep.outpoint:type_name -> lnrpc.OutPoint
	2,  // 22: walletrpc.PendingSweep.witness_type:type_name -> walletrpc.WitnessType
	44, // 23: walletrpc.PendingSweepsResponse.pending_sweeps:type_name -> walletrpc.PendingSweep
	69, // 24: walletrpc.BumpFeeRequest.outpoint:type_name -> lnrpc.OutPoint
	72, // 25: walletrpc.BumpForceCloseFeeRequest.chan_point:type_name -> lnrpc.ChannelPoint
	73, // 26: walletrpc.ListSweepsResponse.transaction_details:type_name -> lnrpc.TransactionDetails
	66, // 27: walletrpc.ListSweepsResponse.transaction_ids:type_name -> walletrpc.ListSweepsResponse.TransactionIDs
	57, // 28: walletrpc.FundPsbtRequest.raw:type_name -> walletrpc.TxTemplate
	58, // 29: walletrpc.FundPsbtRequest.coin_select:type_name -> walletrpc.PsbtCoinSelect
	3,  // 30: walletrpc.FundPsbtRequest.change_type:type_name -> walletrpc.ChangeAddressType
	71, // 31: walletrpc.FundPsbtRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	59, // 32: walletrpc.FundPsbtResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	69, // 33: walletrpc.TxTemplate.inputs:type_name -> lnrpc.OutPoint
	67, // 34: walletrpc.TxTemplate.outputs:type_name -> walletrpc.TxTemplate.OutputsEntry
	69, // 35: walletrpc.UtxoLease.outpoint:type_name -> lnrpc.OutPoint
	59, // 36: walletrpc.ListLeasesResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	4,  // 37: walletrpc.WalletKit.ListUnspent:input_type -> walletrpc.ListUnspentRequest
	6,  // 38: walletrpc.WalletKit.LeaseOutput:input_type -> walletrpc.LeaseOutputRequest
	8,  // 39: walletrpc.WalletKit.ReleaseOutput:input_type -> walletrpc.ReleaseOutputRequest
	64, // 40: walletrpc.WalletKit.ListLeases:input_type -> walletrpc.ListLeasesRequest
	10, // 41: walletrpc.WalletKit.DeriveNextKey:input_type -> walletrpc.KeyReq
	74, // 42: walletrpc.WalletKit.DeriveKey:input_type -> signrpc.KeyLocator
	11, // 43: walletrpc.WalletKit.NextAddr:input_type -> walletrpc.AddrRequest
	22, // 44: walletrpc.WalletKit.GetTransaction:input_type -> walletrpc.GetTransactionRequest
	16, // 45: walletrpc.WalletKit.ListAccounts:input_type -> walletrpc.ListAccountsRequest
	18, // 46: walletrpc.WalletKit.RequiredReserve:input_type -> walletrpc.RequiredReserveRequest
	20, // 47: walletrpc.WalletKit.ListAddresses:input_type -> walletrpc.ListAddressesRequest
	23, // 48: walletrpc.WalletKit.SignMessageWithAddr:input_type -> walletrpc.SignMessageWithAddrRequest
	25, // 49: walletrpc.WalletKit.VerifyMessageWithAddr:input_type -> walletrpc.VerifyMessageWithAddrRequest
	28, // 50: walletrpc.WalletKit.ImportAccount:input_type -> walletrpc.ImportAccountRequest
	...
	22, // 54: walletrpc.WalletKit.RemoveTransaction:input_type -> walletrpc.GetTransactionRequest
	40, // 55: walletrpc.WalletKit.SendOutputs:input_type -> walletrpc.SendOutputsRequest
	42, // 56: walletrpc.WalletKit.EstimateFee:input_type -> walletrpc.EstimateFeeRequest
	45, // 57: walletrpc.WalletKit.PendingSweeps:input_type -> walletrpc.PendingSweepsRequest
	47, // 58: walletrpc.WalletKit.BumpFee:input_type -> walletrpc.BumpFeeRequest
	49, // 59: walletrpc.WalletKit.BumpForceCloseFee:input_type -> walletrpc.BumpForceCloseFeeRequest
	51, // 60: walletrpc.WalletKit.ListSweeps:input_type -> walletrpc.ListSweepsRequest
	53, // 61: walletrpc.WalletKit.LabelTransaction:input_type -> walletrpc.LabelTransactionRequest
	55, // 62: walletrpc.WalletKit.FundPsbt:input_type -> walletrpc.FundPsbtRequest
	60, // 63: walletrpc.WalletKit.SignPsbt:input_type -> walletrpc.SignPsbtRequest
	62, // 64: walletrpc.WalletKit.FinalizePsbt:input_type -> walletrpc.FinalizePsbtRequest
	5,  // 65: walletrpc.WalletKit.ListUnspent:output_type -> walletrpc.ListUnspentResponse
	7,  // 66: walletrpc.WalletKit.LeaseOutput:output_type -> walletrpc.LeaseOutputResponse
	9,  // 67: walletrpc.WalletKit.ReleaseOutput:output_type -> walletrpc.ReleaseOutputResponse
	65, // 68: walletrpc.WalletKit.ListLeases:output_type -> walletrpc.ListLeasesResponse
	75, // 69: walletrpc.WalletKit.DeriveNextKey:output_type -> signrpc.KeyDescriptor
	75, // 70: walletrpc.WalletKit.DeriveKey:output_type -> signrpc.KeyDescriptor
	12, // 71: walletrpc.WalletKit.NextAddr:output_type -> walletrpc.AddrResponse
	76, // 72: walletrpc.WalletKit.GetTransaction:output_type -> lnrpc.Transaction
	17, // 73: walletrpc.WalletKit.ListAccounts:output_type -> walletrpc.ListAccountsResponse
	19, // 74: walletrpc.WalletKit.RequiredReserve:output_type -> walletrpc.RequiredReserveResponse
	21, // 75: walletrpc.WalletKit.ListAddresses:output_type -> walletrpc.ListAddressesResponse
	24, // 76: walletrpc.WalletKit.SignMessageWithAddr:output_type -> walletrpc.SignMessageWithAddrResponse
	27, // 77: walletrpc.WalletKit.VerifyMessageWithAddr:output_type -> walletrpc.VerifyMessageWithAddrResponse
	29, // 78: walletrpc.WalletKit.ImportAccount:output_type -> walletrpc.ImportAccountResponse
	31, // 79: walletrpc.WalletKit.ImportPublicKey:output_type -> walletrpc.ImportPublicKeyResponse
	36, // 80: walletrpc.WalletKit.ImportTapscript:output_type -> walletrpc.ImportTapscriptResponse
	38, // 81: walletrpc.WalletKit.PublishTransaction:output_type -> walletrpc.PublishResponse
	39, // 82: walletrpc.WalletKit.RemoveTransaction:output_type -> walletrpc.RemoveTransactionResponse
	41, // 83: walletrpc.WalletKit.SendOutputs:output_type -> walletrpc.SendOutputsResponse
	43, // 84: walletrpc.WalletKit.EstimateFee:output_type -> walletrpc.EstimateFeeResponse
	46, // 85: walletrpc.WalletKit.PendingSweeps:output_type -> walletrpc.PendingSweepsResponse
	48, // 86: walletrpc.WalletKit.BumpFee:output_type -> walletrpc.BumpFeeResponse
	50, // 87: walletrpc.WalletKit.BumpForceCloseFee:output_type -> walletrpc.BumpForceCloseFeeResponse
	52, // 88: walletrpc.WalletKit.ListSweeps:output_type -> walletrpc.ListSweepsResponse
	54, // 89: walletrpc.WalletKit.LabelTransaction:output_type -> walletrpc.LabelTransactionResponse
	56, // 90: walletrpc.WalletKit.FundPsbt:output_type -> walletrpc.FundPsbtResponse
	61, // 91: walletrpc.WalletKit.SignPsbt:output_type -> walletrpc.SignPsbtResponse
	63, // 92: walletrpc.WalletKit.FinalizePsbt:output_type -> walletrpc.FinalizePsbtResponse
...
func file_walletrpc_walletkit_proto_init() {
	...
	file_walletrpc_walletkit_proto_msgTypes[28].OneofWrappers = []any{
	...
	file_walletrpc_walletkit_proto_msgTypes[48].OneofWrappers = []any{
		(*ListSweepsResponse_TransactionDetails)(nil),
		(*ListSweepsResponse_TransactionIds)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[51].OneofWrappers = []any{
