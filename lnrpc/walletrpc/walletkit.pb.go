...
type FundPsbtRequest struct {
	...
	// The max fee to total output amounts ratio that this psbt should adhere
	// to.
	MaxFeeRatio float32 `protobuf:"fixed32,11,opt,name=max_fee_ratio,json=maxFeeRatio,proto3" json:"max_fee_ratio,omitempty"`
}
...
func (x *FundPsbtRequest) GetMaxFeeRatio() float32 {
	if x != nil {
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8a, 0x04, 0x0a,
	...
	0x69, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x6d, 0x61, 0x78, 0x46, 0x65, 0x65,
	...
	0xd6, 0x11, 0x0a, 0x09, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4b, 0x69, 0x74, 0x12, 0x4c, 0x0a,
