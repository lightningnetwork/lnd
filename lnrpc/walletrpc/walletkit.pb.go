...
type BumpFeeRequest struct {
	...
	Outpoint *lnrpc.OutPoint `protobuf:"bytes,1,opt,name=outpoint,proto3" json:"outpoint,omitempty"`
	// Optional. The target number of blocks that the input should be spent
	// within. The sweeper will use this value as the deadline to create a
	// linear fee function to bump the fee.
	...
	// Optional. The fee rate, expressed in sat/vbyte, that should be used to spend
	// the input with. This value will be used by the sweeper's fee function as its
	// starting fee rate.
	...
	// value greater than the input value will result in CPFP - one or more wallet
	// utxos will be used to pay the fees specified by the budget.
