...
type FundPsbtRequest struct {
	...
	// to.
	MaxFeeRatio float64 `protobuf:"fixed64,11,opt,name=max_fee_ratio,json=maxFeeRatio,proto3" json:"max_fee_ratio,omitempty"`
}
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x6d, 0x61, 0x78, 0x46, 0x65, 0x65,
