...
type PendingSweep struct {
	...
	RequestedSatPerKweight uint32 `protobuf:"varint,9,opt,name=requested_sat_per_kweight,json=requestedSatPerKweight,proto3" json:"requested_sat_per_kweight,omitempty"`
	...
	// created, so it's possible for this to be 0 before this.
	SatPerKweight uint64 `protobuf:"varint,12,opt,name=sat_per_kweight,json=satPerKweight,proto3" json:"sat_per_kweight,omitempty"`
	// The fee rate we'll use to sweep the output, expressed in sat/vbyte. The fee
	// rate is only determined once a sweeping transaction for the output is
	// created, so it's possible for this to be 0 before this.
...
func (x *PendingSweep) GetRequestedSatPerKweight() uint32 {
	if x != nil {
		return x.RequestedSatPerKweight
	}
	return 0
}

func (x *PendingSweep) GetSatPerKweight() uint64 {
	if x != nil {
...
type BumpFeeRequest struct {
	...
	// input with.
	SatPerKweight uint64 `protobuf:"varint,3,opt,name=sat_per_kweight,json=satPerKweight,proto3" json:"sat_per_kweight,omitempty"`
	// Whether this input must be force-swept. This means that it is swept even
	// if it has a negative yield.
...
func (x *BumpFeeRequest) GetSatPerKweight() uint64 {
	if x != nil {
		return x.SatPerKweight
	}
	return 0
...
func (x *FundPsbtRequest) GetSatPerKweight() uint64 {
	if x, ok := x.GetFees().(*FundPsbtRequest_SatPerKweight); ok {
		return x.SatPerKweight
	}
	return 0
}
...
type FundPsbtRequest_SatPerKweight struct {
	// The fee rate, expressed in sat/kweight, that should be used to spend the
	// input with.
	SatPerKweight uint64 `protobuf:"varint,10,opt,name=sat_per_kweight,json=satPerKweight,proto3,oneof"`
}
...
func (*FundPsbtRequest_SatPerKweight) isFundPsbtRequest_Fees() {}
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x08, 0x73, 0x61, 0x74, 0x50, 0x65, 0x72, 0x4b, 0x77, 0x22, 0xa6, 0x04, 0x0a,
	...
	0x74, 0x12, 0x39, 0x0a, 0x19, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x73,
	0x61, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x16, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x53,
	0x61, 0x74, 0x50, 0x65, 0x72, 0x4b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x26, 0x0a, 0x0f,
	0x73, 0x61, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x73, 0x61, 0x74, 0x50, 0x65, 0x72, 0x4b, 0x77, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x73, 0x61, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x5f,
	...
	0x66, 0x6f, 0x72, 0x63, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	...
	0x53, 0x77, 0x65, 0x65, 0x70, 0x73, 0x22, 0xc0, 0x01, 0x0a, 0x0e, 0x42, 0x75, 0x6d, 0x70, 0x46,
	...
	0x65, 0x72, 0x5f, 0x6b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04,
	...
	0x74, 0x50, 0x65, 0x72, 0x56, 0x62, 0x79, 0x74, 0x65, 0x22, 0x29, 0x0a, 0x0f, 0x42, 0x75, 0x6d,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xba, 0x03, 0x0a, 0x0f, 0x46, 0x75, 0x6e,
	...
	0x62, 0x79, 0x74, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x73, 0x61, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x5f,
	0x6b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x04, 0x48, 0x01, 0x52,
	0x0d, 0x73, 0x61, 0x74, 0x50, 0x65, 0x72, 0x4b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x18,
	...
	0x54, 0x59, 0x50, 0x45, 0x5f, 0x50, 0x32, 0x54, 0x52, 0x10, 0x01, 0x32, 0xf6, 0x10, 0x0a, 0x09,
...
func file_walletrpc_walletkit_proto_init() {
	...
	file_walletrpc_walletkit_proto_msgTypes[48].OneofWrappers = []interface{}{
		...
		(*FundPsbtRequest_SatPerKweight)(nil),
	}
