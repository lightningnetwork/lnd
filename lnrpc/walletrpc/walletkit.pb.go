...
type SendOutputsRequest struct {
	...
	//
	//If true, then the transaction created should not be broadcast to the
	//network.
	PreventBroadcast     bool     `protobuf:"varint,3,opt,name=prevent_broadcast,json=preventBroadcast,proto3" json:"prevent_broadcast,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SendOutputsRequest) GetPreventBroadcast() bool {
	if m != nil {
		return m.PreventBroadcast
	}
	return false
}
...
var fileDescriptor_6cc6942ac78249e5 = []byte{
	...
	,
}
