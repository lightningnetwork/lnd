...
type WalletKitClient interface {
	...
	// sweeper and registered for potential fee bumping. Depending on the params
	// chosen, this can be either an RBF or CPFP.
	//
	...
	// perform an RBF.
	//
	// lnd has a central batching engine in which inputs with same deadline are
	// batched together to save on transaction fees. Due to this, we cannot rely
	// on bumping the fee on a specific transaction, since transactions can change
	// at any point with the addition of new inputs. The list of inputs that
	// currently exist within lnd's central batching engine can be retrieved
	// through the PendingSweeps RPC.
	//
	// When bumping the fee of an input that currently exists within lnd's central
	// batching engine, a higher fee transaction will be created that replaces the
	// lower fee transaction through the Replace-By-Fee (RBF) policy.
	//
