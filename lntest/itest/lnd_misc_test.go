...
func testDisableChannelForwarding(net *lntest.NetworkHarness, t *harnessTest) {
	...
	// Send coins to Bob.
	net.SendCoins(t.t, btcutil.SatoshiPerBitcent, net.Bob)
	...
	require.NoErrorf(t.t, err, "unable to call UpdateChanStatus for %s's node", carol.Name())
	...
	assertEdgeDisabled(t, net.Bob, chanPointCarol, true)
