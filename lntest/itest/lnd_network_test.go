...
func testReconnectAfterIPChange(net *lntest.NetworkHarness, t *harnessTest) {
	...
	// Charlie should still able to reconnect to him.
	//
	//    /------- Charlie <-----\
	//    |                      |
	//    v                      |
	...
	// waitForNodeAnnouncement is a closure used to wait for on the
	// given graph subscription for a node announcement from a node with the
	// given public key.
