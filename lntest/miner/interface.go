...
type MinerBackend interface {
	...
	//
	// If setupChain is true, the backend should perform any initial chain
	// setup needed for tests. numMatureOutputs specifies how many mature
	// coinbase outputs should be available after startup.
	...
	// GetRawTransactionVerbose returns verbose information about the given
	// transaction.
