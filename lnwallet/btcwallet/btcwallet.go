...
func (b *BtcWallet) NewAddress(t lnwallet.AddressType, change bool,
	accountName string) (btcaddr.Address, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) IsOurAddress(a btcaddr.Address) bool {
...
func (b *BtcWallet) AddressInfo(a btcaddr.Address) (waddrmgr.ManagedAddress,
	error) {
...
func (b *BtcWallet) ImportAccount(name string, accountPubKey *hdkeychain.ExtendedKey,
	...
	dryRun bool) (*waddrmgr.AccountProperties, []btcaddr.Address,
	...
	externalAddrs := make([]btcaddr.Address, len(extAddrs))
	for i := 0; i < len(extAddrs); i++ {
		externalAddrs[i] = extAddrs[i].Address()
	}

	internalAddrs := make([]btcaddr.Address, len(intAddrs))
