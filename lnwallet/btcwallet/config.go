...
type Config struct {
	// AccountBackupPath is a public recovery file on independent storage.
	// Empty disables synchronous named-account recovery recording.
	AccountBackupPath string

	// AccountBackupCreate explicitly enrolls an existing wallet once.
	// It refuses an existing backup and must be removed after enrollment.
	AccountBackupCreate bool
