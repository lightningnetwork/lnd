...
func (pd *PaymentDescriptor)GetMsgAmt() uint64{
	if pd.AssetID>1{
...
func (lc *LightningChannel) AvailableBalance() uint64 {
	lc.RLock()
	defer lc.RUnlock()
...
func (lc *LightningChannel) availableBalance() (uint64, int64) {
