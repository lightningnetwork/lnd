...
var (
	...
	// ErrMempoolFee is returned from PublishTransaction in case the
	// tx being published is not accepted into mempool because the fee
	// requirements of the mempool backend are not met.
	ErrMempoolFee = errors.New("transaction rejected: min mempool fee " +
		"not met")
)
