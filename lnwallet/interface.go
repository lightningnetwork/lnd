...
// out to the specified outputs. The transaction is created with a default
// change address generated by the wallet.
...
SendOutputsWithChangeAddr(inputs fn.Set[wire.OutPoint], 
