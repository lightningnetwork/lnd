...
func ForceStateTransition(chanA, chanB *LightningChannel) error {
	aliceSig, aliceHtlcSigs, _, aliceNonce, err := chanA.SignNextCommitment()
	if err != nil {
		return err
	}
	err = chanB.ReceiveNewCommitment(aliceSig, aliceHtlcSigs, *aliceNonce)
	if err != nil {
		return err
	}
	...
	bobSig, bobHtlcSigs, _, bobNonce, err := chanB.SignNextCommitment()
	if err != nil {
		return err
	}
	...
	if err := chanA.ReceiveNewCommitment(bobSig, bobHtlcSigs, *bobNonce); err != nil {
		return err
	}
