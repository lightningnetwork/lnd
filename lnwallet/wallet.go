...
// version of the commitment transaction.
func CreateCommitmentTxns(localBalance, remoteBalance, anchorSize btcutil.Amount,
	ourChanCfg, theirChanCfg *channeldb.ChannelConfig,
	localCommitPoint, remoteCommitPoint *btcec.PublicKey,
	fundingTxIn wire.TxIn,
	tweaklessCommit bool, t CommitmentType) (*wire.MsgTx, *wire.MsgTx, error) {
	...
	ourCommitTx, err := CreateCommitTx(
		...
		localBalance, remoteBalance, anchorSize, false, t,
	)
	if err != nil {
		return nil, nil, err
	}
	...
	theirCommitTx, err := CreateCommitTx(
		...
		remoteBalance, localBalance, anchorSize, false, t,
	)
	if err != nil {
		return nil, nil, err
	}
...
func (l *LightningWallet) handleContributionMsg(req *addContributionMsg) {
	...
	t, err := CommitmentFromChanType(pendingReservation.partialState.ChanType)
	if err != nil {
		req.err <- err
		return
	}
	...
	ourCommitTx, theirCommitTx, err := CreateCommitmentTxns(
		localBalance, remoteBalance, anchorSize, ourContribution.ChannelConfig,
...
func (l *LightningWallet) handleSingleFunderSigs(req *addSingleFunderSigsMsg) {
	...
	tweaklessCommits := pendingReservation.partialState.ChanType.IsTweakless()
	ourCommitTx, theirCommitTx, err := CreateCommitmentTxns(
		localBalance, remoteBalance, anchorSize,
		...
		*fundingTxIn, tweaklessCommits, t,
	)
	if err != nil {
		req.err <- err
		req.completeChan <- nil
