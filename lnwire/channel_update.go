...
const (
	...
	// msg should be forwarded to other peers when
	// received.
	// NOTE: We currently do not check this bit when receiving a channel
	// update from the peer to make sure we do not relay it because
	// we already have other means (AuthProof) to do so.
