...
// NodeAnnouncement2 is used to signal the presence of a node on the network
// along with information about the node that can be used to connect to it. This
// announcement is to be used in the gossip 1.75 protocol.
