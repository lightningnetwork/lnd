...
func (o *OnionMessagePayload) Decode(r io.Reader) (*OnionMessagePayload,
	...
	// If we read out an invoice or invoice error tlv sub-namespace, add it
	// to our set of final payloads. This value won't have been added in the
	// loop above, because we recognized the TLV so
