...
/*
Creates a new network test harness.
*/
func newNetworkHarness() (*networkHarness, error) {
 ...
 /*
 Given an already running instance of btcd's rpctest harness and extra command line flags
 ( which should be formatted properly - "--arg=value") initialized alice and bob nodes.
...
// Logs from lightning node being generated with delay - you should add time.Sleep() in
