...
// router that would consume a valid Ping.
func TestPeerPingFloodDisconnects(t *testing.T) {
	...
	// Arrange: Encode a valid Pong request and register the
	...
	// Act: Send the valid Ping through normal decoding, then wait for
