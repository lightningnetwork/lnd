...
// that instructs the daemon to send the send of contained message to the
// target peer.
...
// DisableChannelEvent instructs the daemon to send out a new channel disable
// message on the gossip network.
//
// TODO(roasbeef); also mark as borked on disk?
...
// daemonSealed indicates that this struct is a DaemonEvent instance.
func (s *DisableChannelEvent) daemonSealed() {}
