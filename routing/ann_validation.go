...
func ValidateChannelUpdateAnn(pubKey *btcec.PublicKey, capacity btcutil.Amount,
	...
	return validateOptionalFields(capacity, a)
}
...
func validateOptionalFields(capacity btcutil.Amount,
	...
	switch msg.MessageFlags {
	case 0:
		if msg.HtlcMaximumMsat != 0 {
			return errors.Errorf("invalid message flags for channel update %v",
				spew.Sdump(msg))
		}
	case 1:
		if msg.HtlcMaximumMsat == 0 ||
			msg.HtlcMaximumMsat < msg.HtlcMinimumMsat {
			return errors.Errorf("invalid max htlc for channel update %v",
				spew.Sdump(msg))
		}
		if msg.HtlcMaximumMsat > lnwire.NewMSatFromSatoshis(capacity) {
			return errors.Errorf("invalid max htlc for channel update %v",
				spew.Sdump(msg))
		}
	}
