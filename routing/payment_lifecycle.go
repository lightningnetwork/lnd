...
func (p *paymentLifecycle) decideNextStep(
	payment pymtpkg.Payment) (stateStep, error) {
...
func (p *paymentLifecycle) requestRoute(
	ps *pymtpkg.MPPaymentState) (*route.Route, error) {
...
// `resultCollected`.
func (p *paymentLifecycle) collectResultAsync(attempt *pymtpkg.HTLCAttempt) {
...
func (p *paymentLifecycle) collectResult(
	attempt *pymtpkg.HTLCAttempt) (*htlcswitch.PaymentResult, error) {
...
func (p *paymentLifecycle) registerAttempt(rt *route.Route,
	remainingAmt lnwire.MilliSatoshi) (*pymtpkg.HTLCAttempt, error) {
...
func (p *paymentLifecycle) createNewPaymentAttempt(rt *route.Route,
	lastShard bool) (*pymtpkg.HTLCAttempt, error) {
...
func (p *paymentLifecycle) sendAttempt(
	attempt *pymtpkg.HTLCAttempt) (*attemptResult, error) {
...
func (p *paymentLifecycle) failPaymentAndAttempt(
	attemptID uint64, reason *pymtpkg.FailureReason,
...
func (p *paymentLifecycle) handleSwitchErr(attempt *pymtpkg.HTLCAttempt,
	sendErr error) (*attemptResult, error) {

	internalErrorReason := pymtpkg.FailureReasonError
...
func marshallError(sendError error, time time.Time) *pymtpkg.HTLCFailInfo {
	response := &pymtpkg.HTLCFailInfo{
		FailTime: time,
	}

	switch {
	case errors.Is(sendError, htlcswitch.ErrPaymentIDNotFound):
		response.Reason = pymtpkg.HTLCFailInternal
		return response

	case errors.Is(sendError, htlcswitch.ErrUnreadableFailureMessage):
		response.Reason = pymtpkg.HTLCFailUnreadable
		return response
	}
	...
	if message != nil {
		response.Reason = pymtpkg.HTLCFailMessage
		response.Message = message
	} else {
		response.Reason = pymtpkg.HTLCFailUnknown
	}
...
func (p *paymentLifecycle) patchLegacyPaymentHash(
	a pymtpkg.HTLCAttempt) pymtpkg.HTLCAttempt {
...
func (p *paymentLifecycle) reloadInflightAttempts() (pymtpkg.Payment, error) {
...
func (p *paymentLifecycle) reloadPayment() (pymtpkg.Payment,
	*pymtpkg.MPPaymentState, error) {
...
// the htlcswitch.
func (p *paymentLifecycle) handleAttemptResult(attempt *pymtpkg.HTLCAttempt,
