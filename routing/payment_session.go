...
func (e noRouteError) FailureReason() pymtpkg.FailureReason {
	switch e {
	case
		errNoTlvPayload,
		errNoPaymentAddr,
		...
		return pymtpkg.FailureReasonNoRoute

	case errInsufficientBalance:
		return pymtpkg.FailureReasonInsufficientBalance

	default:
		return pymtpkg.FailureReasonError
	}
}
