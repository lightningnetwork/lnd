...
func (r *ChannelRouter) SendToRoute(htlcHash lntypes.Hash, rt *route.Route,
	firstHopCustomRecords lnwire.CustomRecords) (*pymtpkg.HTLCAttempt,
	error) {
...
func (r *ChannelRouter) sendToRoute(htlcHash lntypes.Hash, rt *route.Route,
	...
	case mpp != nil && errors.Is(err, pymtpkg.ErrPaymentInFlight):
	case mpp != nil && errors.Is(err, pymtpkg.ErrPaymentExists):
...
func (r *ChannelRouter) resumePayments() error {
	...
	launchPayment := func(payment *pymtpkg.MPPayment) {
		defer r.wg.Done()
...
func (r *ChannelRouter) failStaleAttempt(a pymtpkg.HTLCAttempt,
