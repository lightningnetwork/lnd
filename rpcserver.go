...
func (r *rpcServer) SendCoins(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "sendcoins",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) NewAddress(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "newaddress",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) VerifyMessage(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "verifymessage",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) ConnectPeer(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "connectpeer",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) DisconnectPeer(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "disconnectpeer",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) OpenChannel(in *lnrpc.OpenChannelRequest,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "openchannel",
			r.authSvc); err != nil {
			return err
		}
	}
...
func (r *rpcServer) CloseChannel(in *lnrpc.CloseChannelRequest,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "closechannel",
			r.authSvc); err != nil {
			return err
		}
	}
...
func (r *rpcServer) GetInfo(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "getinfo",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) ListPeers(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "listpeers",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) WalletBalance(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "walletbalance",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) ChannelBalance(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "channelbalance",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) PendingChannels(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "listchannels",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func routeFilter(ctx context.Context, svc *bakery.Service) func(*routing.Route) error {
	return func(route *routing.Route) error {
		...
		ctx = context.WithValue(ctx, macaroons.PaymentPathContextKey, nodes)
		if svc != nil {
			if err := macaroons.ValidateMacaroonWithCheckers(ctx, svc,
				macaroons.DefaultCheckers...); err != nil {
				return err
			}
		}
		return nil
...
func (r *rpcServer) SendPayment(paymentStream lnrpc.Lightning_SendPaymentServer) error {
	// Check macaroon to see if this is allowed.
	ctx := paymentStream.Context()
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "sendpayment",
			r.authSvc); err != nil {
			return err
		}
	}
...
func (r *rpcServer) AddInvoice(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "addinvoice",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) LookupInvoice(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "readinvoices",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) SubscribeTransactions(req *lnrpc.GetTransactionsRequest,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "gettransactions",
			r.authSvc); err != nil {
			return err
		}
	}
...
func (r *rpcServer) DescribeGraph(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "describegraph",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) GetChanInfo(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "getchaninfo",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) GetNodeInfo(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "getnodeinfo",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) QueryRoutes(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "queryroutes",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) GetNetworkInfo(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "getnetworkinfo",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) StopDaemon(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "stopdaemon",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) ListPayments(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "listpayments",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) DeleteAllPayments(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "deleteallpayments",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) SetAlias(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "setalias",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) DebugLevel(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "debuglevel",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) DecodePayReq(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "decodepayreq",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) FeeReport(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "feereport",
			r.authSvc); err != nil {
			return nil, err
		}
	}
...
func (r *rpcServer) UpdateFees(ctx context.Context,
	...
	var err error
	if r.authSvc != nil {
		if ctx, err = macaroons.ValidateMacaroon(ctx, "udpatefees",
			r.authSvc); err != nil {
			return nil, err
		}
	}
