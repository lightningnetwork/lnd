...
// activeNetParams returns a string representation of the currect active
// network.
...
func (r *rpcServer) SendCoins(ctx context.Context,
	...
	if !targetAddr.IsForNet(activeNetParams.Params) {
		...
		return nil, fmt.Errorf("address: %v is not valid for this network: %v",
			targetAddr.String(), netName,
		)
	}
