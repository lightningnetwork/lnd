...
func newServer(ctx context.Context, cfg *Config, listenAddrs []net.Addr,
	...
	selfNode, err := s.getSelfNode(
		ctx, selfAddrs, nodeKeyDesc, serializedPubKey,
	)
	if err != nil {
		return nil, err
	}
...
func (s *server) getSelfNode(ctx context.Context, selfAddrs []net.Addr,
	nodeKeyDesc *keychain.KeyDescriptor,
	serializedPubKey [33]byte) (*models.LightningNode, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("unable to generate signature for self "+
