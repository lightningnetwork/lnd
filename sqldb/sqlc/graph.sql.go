...
func (q *Queries) DeleteChannels(ctx context.Context, ids []int64) error {
	...
	if len(ids) > 0 {
		...
		params, err := makeQueryParams(len(queryParams), len(ids))
		if err != nil {
			return err
		}
		query = strings.Replace(query, "/*SLICE:ids*/?", params, 1)
	} else {
...
func (q *Queries) GetChannelsByOutpoints(ctx context.Context, outpoints []string) ([]GetChannelsByOutpointsRow, error) {
	...
	if len(outpoints) > 0 {
		...
		params, err := makeQueryParams(len(queryParams), len(outpoints))
		if err != nil {
			return nil, err
		}
		query = strings.Replace(query, "/*SLICE:outpoints*/?", params, 1)
	} else {
...
func (q *Queries) GetChannelsBySCIDWithPolicies(ctx context.Context, arg GetChannelsBySCIDWithPoliciesParams) ([]GetChannelsBySCIDWithPoliciesRow, error) {
	...
	if len(arg.Scids) > 0 {
		...
		params, err := makeQueryParams(len(queryParams), len(arg.Scids))
		if err != nil {
			return nil, err
		}
		query = strings.Replace(query, "/*SLICE:scids*/?", params, 1)
	} else {
