...
-- Create an indexes on the id and add_index columns to speed up lookups.
CREATE INDEX IF NOT EXISTS invoice_payment_hashes_id_idx ON invoice_payment_hashes(id);
