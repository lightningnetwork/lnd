...
CREATE INDEX idx_htlc_payment_id ON payment_htlc_attempts(payment_id);

-- Index for the htlc attempts to query by attempt index.
CREATE INDEX idx_htlc_attempt_index ON payment_htlc_attempts(attempt_index);

-- Index for the htlc attempts to query by payment hash.
CREATE INDEX idx_htlc_payment_hash ON payment_htlc_attempts(payment_hash);

-- Index for the htlc attempts by attempt time.
CREATE INDEX idx_htlc_attempt_time ON payment_htlc_attempts(attempt_time);
...
CREATE INDEX idx_route_hops_htlc_attempt_index ON payment_route_hops(htlc_attempt_index);
...
CREATE INDEX idx_first_hop_custom_records_payment_id ON payment_first_hop_custom_records(payment_id);
...
CREATE INDEX idx_htlc_attempt_custom_records_htlc_attempt_index ON payment_htlc_attempt_custom_records(htlc_attempt_index);
...
-- Index of the hop id.
CREATE INDEX idx_route_hop_custom_records_hop_id ON payment_route_hop_custom_records(hop_id);
