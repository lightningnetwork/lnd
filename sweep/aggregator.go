...
// inputs have been filtred out, all the inputs have been sorted based on their
// budgets, and we are about to create input sets. The only thing missing here
// is, we need to group the inputs here even further based on whether their
// budgets can cover the starting fee rate used for this input set.
