...
type AuxSweeper interface {
	...
	// The skipBroadcast parameter indicates whether the transaction is
	// already confirmed on-chain (true for breach sweeps) or needs to be
	// broadcast (false for normal sweeps).
	NotifyBroadcast(req *BumpRequest, tx *wire.MsgTx,
		totalFees btcutil.Amount,
		outpointToTxIndex map[wire.OutPoint]int,
		skipBroadcast bool) error
}
