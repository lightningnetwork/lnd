...
// is preserved. None applies to any failure path that carries no fee-rate
// signal, which covers the resource failures handled by isResourceFailure as
// well as non-fee initial errors such as ErrTxNoOutput and ErrZeroFeeRateDelta.
