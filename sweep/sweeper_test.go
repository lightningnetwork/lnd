...
// TestHandleBumpEventTxFailedNoBadInputs checks that malformed BadInputs
// diagnosis retries the whole set without marking anything fatal.
func TestHandleBumpEventTxFailedNoBadInputs(t *testing.T) {
	t.Parallel()
	...
	set.On("Inputs").Return([]input.Input{input1, input2})
